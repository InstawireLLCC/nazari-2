...
function GoogleMaps_InfoBox_Factory(e) {
  ...
  return (t.prototype = new google.maps.OverlayView).createInfoBoxDiv_ = function() {
      function t(e) {
      ...
      if (!this.div_) {
          if (this.div_ = document.createElement("div"), this.setBoxStyle_(), void 0 === this.content_.nodeType ? this.div_.innerHTML = this.getCloseBoxImg_() + this.content_ : (this.div_.innerHTML = this.getCloseBoxImg_(), this.div_.appendChild(this.content_)), this.getPanes()[this.pane_].appendChild(this.div_), this.addClickHandler_(), this.div_.style.width ? this.fixedWidthSet_ = !0 : 0 !== this.maxWidth_ && this.div_.offsetWidth > this.maxWidth_ ? (this.div_.style.width = this.maxWidth_, this.div_.style.overflow = "auto", this.fixedWidthSet_ = !0) : (n = this.getBoxWidths_(), this.div_.style.width = this.div_.offsetWidth - n.left - n.right + "px", this.fixedWidthSet_ = !1), this.panBox_(this.disableAutoPan_), !this.enableEventPropagation_) {
              for (this.eventListeners_ = [], i = ["mousedown", "mouseover", "mouseout", "mouseup", "click", "dblclick", "touchstart", "touchend", "touchmove"], e = 0; e < i.length; e++) this.eventListeners_.push(google.maps.event.addDomListener(this.div_, i[e], t));
              this.eventListeners_.push(google.maps.event.addDomListener(this.div_, "mouseover", function(e) {
                  this.style.cursor = "default"
              }))
          }
          this.contextListener_ = google.maps.event.addDomListener(this.div_, "contextmenu", function(e) {
              e.returnValue = !1, e.preventDefault && e.preventDefault(), o.enableEventPropagation_ || t(e)
          }), google.maps.event.trigger(this, "domready")
      }
  }, t.prototype.getCloseBoxImg_ = function() {
      var e = "";
      return "" !== this.closeBoxURL_ && (e = "<img", e += " src='" + this.closeBoxURL_ + "'", e += " align=right", e += " title='" + this.closeBoxTitle_ + "'", e += " style='", e += " position: relative;", e += " cursor: pointer;", e += " margin: " + this.closeBoxMargin_ + ";", e += "'>"), e
      ...
      if (!e && (t = this.getMap()) instanceof google.maps.Map) {
          ...
          if (2 == t.panToBounds.length) {
              ...
              u.left = -o + l, u.right = o + s + l, this.alignBottom_ ? (u.top = -r + c + a, u.bottom = r + c) : (u.top = -r + c, u.bottom = r + a + c), t.panToBounds(new google.maps.LatLngBounds(this.position_), u)
          } else {
              var h = t.getDiv(),
                  d = h.offsetWidth,
                  f = h.offsetHeight,
                  p = this.getProjection().fromLatLngToContainerPixel(this.position_);
              if (p.x < -o + l ? i = p.x + o - l : p.x + s + o + l > d && (i = p.x + s + o + l - d), this.alignBottom_ ? p.y < -r + c + a ? n = p.y + r - c - a : p.y + r + c > f && (n = p.y + r + c - f) : p.y < -r + c ? n = p.y + r - c : p.y + a + r + c > f && (n = p.y + a + r + c - f), 0 !== i || 0 !== n) {
                  t.getCenter();
                  t.panBy(i, n)
              }
          }
      ...
      var i = this;
      t && (this.setPosition(t.getPosition()), this.moveListener_ = google.maps.event.addListener(t, "position_changed", function() {
          i.setPosition(this.getPosition())
      })), this.setMap(e), this.div_ && this.panBox_(this.disableAutoPan_)
  ...
  function p(e) {
      return "function" != typeof h.createElement ? h.createElement(e) : v ? h.createElementNS.call(h, "http://www.w3.org/2000/svg", e) : h.createElement.apply(h, arguments)
  }
  ...
  function s(e, t, i, n) {
      ...
      if (parseInt(i, 10))
          for (; i--;)(s = p("div")).id = n ? n[i] : l + (i + 1), c.appendChild(s);
      return (o = p("style")).type = "text/css", o.id = "s" + l, (u.fake ? u : c).appendChild(o), u.appendChild(c), o.styleSheet ? o.styleSheet.cssText = e : o.appendChild(h.createTextNode(e)), c.id = l, u.fake && (u.style.background = "", u.style.overflow = "hidden", a = g.style.overflow, g.style.overflow = "hidden", g.appendChild(u)), r = t(c, e), u.fake ? (u.parentNode.removeChild(u), g.style.overflow = a, g.offsetHeight) : c.parentNode.removeChild(c), !!r
  }
  ...
  function m(e, t) {
      ...
      if ("CSS" in r && "supports" in r.CSS) {
          for (; i--;)
              if (r.CSS.supports(o(e[i]), t)) return !0;
          return !1
      }
      if ("CSSSupportsRule" in r) {
          for (var n = []; i--;) n.push("(" + o(e[i]) + ":" + t + ")");
          return s("@supports (" + (n = n.join(" or ")) + ") { #modernizr { position: absolute; } }", function(e) {
  ...
  function n(e, t, i, n, o) {
      ...
      return f(t, "string") || f(t, "undefined") ? function(e, t, i, n) {
          ...
          for (var s, a, l, c, u, h = ["modernizr", "tspan", "samp"]; !w.style && h.length;) s = !0, w.modElem = p(h.shift()), w.style = w.modElem.style;
          for (l = e.length, a = 0; a < l; a++)
              if (c = e[a], u = w.style[c], !~("" + c).indexOf("-") || (c = c.replace(/([a-z])-([a-z])/g, function(e, t, i) {
          ...
          var n;
          for (var o in e)
              if (e[o] in t) return !1 === i ? e[o] : f(n = t[e[o]], "function") ? a(n, i || t) : n;
          return !1
  ...
  u._q.unshift(function() {
          delete w.style
      }), t.testAllProps = n, t.testAllProps = e, u.addTest("cssmask", e("maskRepeat", "repeat-x", !0)),
      function() {
          var e, t, i, n, o, r;
          for (var s in c)
              if (c.hasOwnProperty(s)) {
                  ...
                  for (n = f(t.fn, "function") ? t.fn() : t.fn, o = 0; o < e.length; o++) 1 === (r = e[o].split(".")).length ? u[r[0]] = n : (!u[r[0]] || u[r[0]] instanceof Boolean || (u[r[0]] = new Boolean(u[r[0]])), u[r[0]][r[1]] = n), l.push((n ? "" : "no-") + r.join("-"))
              }
      }(),
      function(e) {
          var t = g.className,
          ...
          u._config.enableClasses && (t += " " + i + e.join(" " + i), v ? g.className.baseVal = t : g.className = t)
...
function(e, t) {
  ...
  return function() {
      "use strict";
      var g = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function(e) {
      ...
      function s(e, t) {
          ...
          var i = "position: absolute; left: 0; top: 0; right: 0; bottom: 0; overflow: hidden; z-index: -1; visibility: hidden; opacity: 0;",
              n = "position: absolute; left: 0; top: 0; transition: 0s;";
          e.resizeSensor.style.cssText = i, e.resizeSensor.innerHTML = '<div class="resize-sensor-expand" style="' + i + '"><div style="' + n + '"></div></div><div class="resize-sensor-shrink" style="' + i + '"><div style="' + n + ' width: 200%; height: 200%"></div></div>', e.appendChild(e.resizeSensor), "static" == function(e, t) {
              return e.currentStyle ? e.currentStyle[t] : window.getComputedStyle ? window.getComputedStyle(e, null).getPropertyValue(t) : e.style[t]
          }(e, "position") && (e.style.position = "relative");

          function o() {
              s.style.width = 1e5 + "px", s.style.height = 1e5 + "px", r.scrollLeft = 1e5, r.scrollTop = 1e5, a.scrollLeft = 1e5, a.scrollTop = 1e5
          }
          ...
          var l, c, u, h, d = !1,
              f = function() {
                  e.resizedAttached && (d && (e.resizedAttached.call(), d = !1), g(f))
              };
          g(f);

          function p() {
              (u = e.offsetWidth) == l && (h = e.offsetHeight) == c || (d = !0, l = u, c = h), o()
          }
      ...
      function o(e, t) {
          var i = Object.prototype.toString.call(e),
              n = this._isCollectionTyped = "[object Array]" === i || "[object NodeList]" === i || "[object HTMLCollection]" === i || "undefined" != typeof jQuery && e instanceof window.jQuery || "undefined" != typeof Elements && e instanceof window.Elements;
      ...
      return o.prototype.detach = function() {
          var e = this._isCollectionTyped,
              t = this._element;
          if (e)
              for (var i = 0, n = t.length; i < n; i++) o.detach(t[i]);
          else o.detach(t)
      }, o.detach = function(e) {
...
function(e, t) {
  ...
  C.fn = C.prototype = {
      ...
      makeArray: function(e, t) {
          var i = t || [];
          return null != e && (d(Object(e)) ? C.merge(i, "string" == typeof e ? [e] : e) : l.call(i, e)), i
      },
  ...
  var f = function(i) {
      ...
      var e, f, _, r, s, p, d, m, w, l, c, x, E, a, S, g, u, v, y, C = "sizzle" + 1 * new Date,
          b = i.document,
          T = 0,
          n = 0,
          k = le(),
      ...
      try {
          O.apply(t = M.call(b.childNodes), b.childNodes), t[b.childNodes.length].nodeType
      } catch (e) {
          O = {
      ...
      function ae(t, e, i, n) {
          ...
          if (!n && ((e ? e.ownerDocument || e : b) !== E && x(e), e = e || E, S)) {
              if (11 !== d && (l = te.exec(t)))
                  if (o = l[1]) {
                      if (9 === d) {
                      ...
                      if ((o = l[3]) && f.getElementsByClassName && e.getElementsByClassName) return O.apply(i, e.getElementsByClassName(o)), i
                  } if (f.qsa && !I[t + " "] && (!g || !g.test(t)) && (1 !== d || "object" !== e.nodeName.toLowerCase())) {
                  if (u = t, h = e, 1 === d && Y.test(t)) {
                      for ((a = e.getAttribute("id")) ? a = a.replace(oe, re) : e.setAttribute("id", a = C), r = (c = p(t)).length; r--;) c[r] = "#" + a + " " + be(c[r]);
      ...
      for (e in f = ae.support = {}, s = ae.isXML = function(e) {
              ...
              return n !== E && 9 === n.nodeType && n.documentElement && (a = (E = n).documentElement, S = !s(E), b !== E && (i = E.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", o, !1) : i.attachEvent && i.attachEvent("onunload", o)), f.attributes = ue(function(e) {
              ...
              }, u = [], g = [], (f.qsa = ee.test(E.querySelectorAll)) && (ue(function(e) {
                  ...
                  return i || (1 & (i = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !f.sortDetached && t.compareDocumentPosition(e) === i ? e === E || e.ownerDocument === b && y(b, e) ? -1 : t === E || t.ownerDocument === b && y(b, t) ? 1 : l ? z(l, e) - z(l, t) : 0 : 4 & i ? -1 : 1)
              } : function(e, t) {
                  if (e === t) return c = !0, 0;
                  var i, n = 0,
                      o = e.parentNode,
                      ...
                      s = [e],
                      a = [t];
                  if (!o || !r) return e === E ? -1 : t === E ? 1 : o ? -1 : r ? 1 : l ? z(l, e) - z(l, t) : 0;
                  if (o === r) return de(e, t);
                  for (i = e; i = i.parentNode;) s.unshift(i);
                  for (i = t; i = i.parentNode;) a.unshift(i);
                  for (; s[n] === a[n];) n++;
                  return n ? de(s[n], a[n]) : s[n] === b ? -1 : a[n] === b ? 1 : 0
              }), E
          }, ae.matches = function(e, t) {
              return ae(e, null, null, t)
          }, ae.matchesSelector = function(e, t) {
              if ((e.ownerDocument || e) !== E && x(e), f.matchesSelector && S && !I[t + " "] && (!u || !u.test(t)) && (!g || !g.test(t))) try {
                  var i = v.call(e, t);
              ...
              preFilter: {
                  ...
                  PSEUDO: function(e) {
                      var t, i = !e[6] && e[2];
                      return G.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : i && Q.test(i) && (t = p(i, !0)) && (t = i.indexOf(")", i.length - t) - i.length) && (e[0] = e[0].slice(0, t), e[2] = i.slice(0, t)), e.slice(0, 3))
                  }
              },
              filter: {
                  TAG: function(e) {
                      ...
                      return 1 === m && 0 === g ? function(e) {
                          ...
                          if (u) {
                              ...
                              if (l = [y ? u.firstChild : u.lastChild], y && d) {
                                  for (f = (a = (n = (o = (r = (s = u)[C] || (s[C] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === T && n[1]) && n[2], s = a && u.childNodes[a]; s = ++a && s && s[c] || (f = a = 0) || l.pop();)
                                      if (1 === s.nodeType && ++f && s === e) {
                                          o[p] = [T, a, f];
                                          break
                                      }
                              } else if (d && (f = a = (n = (o = (r = (s = e)[C] || (s[C] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === T && n[1]), !1 === f)
                                  for (;
                                      (s = ++a && s && s[c] || (f = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== h : 1 !== s.nodeType) || !++f || (d && ((o = (r = s[C] || (s[C] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] = [T, f]), s !== e)););
                  ...
                  PSEUDO: function(e, r) {
                      ...
                      return s[C] ? s(r) : 1 < s.length ? (t = [e, e, "", r], _.setFilters.hasOwnProperty(e.toLowerCase()) ? ce(function(e, t) {
                          for (var i, n = s(e, r), o = n.length; o--;) e[i = z(e, n[o])] = !(t[i] = n[o])
                      }) : function(e) {
                          return s(e, 0, t)
                      }) : s
                  }
              ...
              pseudos: {
                  ...
                  lang: ce(function(i) {
                      return X.test(i || "") || ae.error("unsupported lang: " + i), i = i.replace(ne, h).toLowerCase(),
                          function(e) {
                              var t;
                              do {
                  ...
                  for (; e = e[l];)
                      if (1 === e.nodeType || h)
                          if (o = (r = e[C] || (e[C] = {}))[e.uniqueID] || (r[e.uniqueID] = {}), c && c === e.nodeName.toLowerCase()) e = e[l] || e;
                              ...
                              if ((n = o[u]) && n[0] === T && n[1] === d) return s[2] = n[2];
      ...
      function Ee(f, p, m, g, v, e) {
          return g && !g[C] && (g = Ee(g)), v && !v[C] && (v = Ee(v, e)), ce(function(e, t, i, n) {
              var o, r, s, a = [],
                  l = [],
                  c = t.length,
                  u = e || function(e, t, i) {
                  ...
                  d = m ? v || (e ? f : c || g) ? [] : t : h;
              if (m && m(h, d, i, n), g)
                  for (o = xe(d, l), g(o, [], i, n), r = o.length; r--;)(s = o[r]) && (d[l[r]] = !(h[l[r]] = s));
              if (e) {
                  if (v || f) {
                      if (v) {
                      ...
                      for (r = d.length; r--;)(s = d[r]) && -1 < (o = v ? z(e, s) : a[r]) && (e[o] = !(t[o] = s))
                  }
      ...
      function Se(e) {
          for (var o, t, i, n = e.length, r = _.relative[e[0].type], s = r || _.relative[" "], a = r ? 1 : 0, l = _e(function(e) {
                  return e === o
              }, s, !0), c = _e(function(e) {
                  return -1 < z(o, e)
              }, s, !0), u = [function(e, t, i) {
                  var n = !r && (i || t !== w) || ((o = t).nodeType ? l(e, t, i) : c(e, t, i));
                  return o = null, n
              }]; a < n; a++)
              if (t = _.relative[e[a].type]) u = [_e(we(u), t)];
                  ...
                  if ((t = _.filter[e[a].type].apply(null, e[a].matches))[C]) {
                      ...
                      return Ee(1 < a && we(u), 1 < a && be(e.slice(0, a - 1).concat({
                          value: " " === e[a - 2].type ? "*" : ""
                      })).replace($, "$1"), t, a < i && Se(e.slice(a, i)), i < n && Se(e = e.slice(i)), i < n && be(e))
                  }
                  u.push(t)
              } return we(u)
      }
      return ye.prototype = _.filters = _.pseudos, _.setFilters = new ye, p = ae.tokenize = function(e, t) {
          ...
          for (s = e, a = [], l = _.preFilter; s;) {
              for (r in i && !(n = V.exec(s)) || (n && (s = s.slice(n[0].length) || s), a.push(o = [])), i = !1, (n = U.exec(s)) && (i = n.shift(), o.push({
                      value: i,
                      type: n[0].replace($, " ")
                  }), s = s.slice(i.length)), _.filter) !(n = G[r].exec(s)) || l[r] && !(n = l[r](n)) || (i = n.shift(), o.push({
                  value: i,
                  type: r,
                  matches: n
              }), s = s.slice(i.length));
          ...
          var i, n = [],
              ...
              r = D[e + " "];
          if (!r) {
              for (i = (t = t || p(e)).length; i--;)(r = Se(t[i]))[C] ? n.push(r) : o.push(r);
              (r = D(e, function(g, v) {
                  function e(e, t, i, n, o) {
                      var r, s, a, l = 0,
                          ...
                          m = f.length;
                      for (o && (w = t === E || t || o); c !== m && null != (r = f[c]); c++) {
                          if (b && r) {
                              for (s = 0, t || r.ownerDocument === E || (x(r), i = !S); a = g[s++];)
                                  if (a(r, t || E, i)) {
                                      n.push(r);
                                      break
                                  } o && (T = p)
                      ...
                      if (l += c, y && c !== l) {
                          ...
                          O.apply(n, h), o && !e && 0 < h.length && 1 < l + v.length && ae.uniqueSort(n)
                      }
                      return o && (T = p, w = d), u
                  }
                  var y = 0 < v.length,
          ...
          if (i = i || [], 1 === u.length) {
              if (2 < (r = u[0] = u[0].slice(0)).length && "ID" === (s = r[0]).type && 9 === t.nodeType && S && _.relative[r[1].type]) {
                  if (!(t = (_.find.ID(s.matches[0].replace(ne, h), t) || [])[0])) return i;
                  c && (t = t.parentNode), e = e.slice(r.shift().value.length)
              }
              for (o = G.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !_.relative[a = s.type]);)
                  if ((l = _.find[a]) && (n = l(s.matches[0].replace(ne, h), ie.test(r[0].type) && ve(t.parentNode) || t))) {
                      if (r.splice(o, 1), !(e = n.length && be(r))) return O.apply(i, n), i;
                      break
                  }
          }
          return (c || d(e, u))(n, t, !S, i, !t || ie.test(e) && ve(t.parentNode) || t), i
      }, f.sortStable = C.split("").sort(L).join("") === C, f.detectDuplicates = !!c, x(), f.sortDetached = ue(function(e) {
  ...
  C.filter = function(e, t, i) {
      ...
      is: function(e) {
          return !!D(this, "string" == typeof e && T.test(e) ? C(e) : e || [], !1).length
      }
  });
  var I, L = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
  (C.fn.init = function(e, t, i) {
      var n, o;
      if (!e) return this;
      if (i = i || I, "string" != typeof e) return e.nodeType ? (this[0] = e, this.length = 1, this) : b(e) ? void 0 !== i.ready ? i.ready(e) : e(C) : C.makeArray(e, this);
      if (!(n = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : L.exec(e)) || !n[1] && t) return !t || t.jquery ? (t || i).find(e) : this.constructor(t).find(e);
      if (n[1]) {
          if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : S, !0)), A.test(n[1]) && C.isPlainObject(t))
              for (n in t) b(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
          return this
      }
      return (o = S.getElementById(n[2])) && (this[0] = o, this.length = 1), this
  }).prototype = C.fn, I = C(S);
  ...
  C.fn.extend({
      ...
      C.fn[n] = function(e, t) {
          ...
          return "Until" !== n.slice(-5) && (t = e), t && "string" == typeof t && (i = C.filter(t, i)), 1 < this.length && (j[n] || C.uniqueSort(i), P.test(n) && i.reverse()), this.pushStack(i)
      }
  });
  var O = /[^\x20\t\r\n\f]+/g;
  ...
  C.Callbacks = function(n) {
      n = "string" == typeof n ? function(e) {
          var i = {};
          return C.each(e.match(O) || [], function(e, t) {
              i[t] = !0
          }), i
      }(n) : C.extend({}, n);
      ...
      function i() {
          for (r = r || n.once, t = o = !0; a.length; l = -1)
              for (e = a.shift(); ++l < s.length;) !1 === s[l].apply(e[0], e[1]) && n.stopOnFalse && (l = s.length, e = !1);
      ...
      var o, e, t, r, s = [],
          ...
          c = {
              add: function() {
                  return s && (e && !o && (l = s.length - 1, a.push(e)), function i(e) {
                      C.each(e, function(e, t) {
                          b(t) ? n.unique && c.has(t) || s.push(t) : t && t.length && "string" !== w(t) && i(t)
                      })
                  }(arguments), e && !o && i()), this
              },
              remove: function() {
                  return C.each(arguments, function(e, t) {
                      for (var i; - 1 < (i = C.inArray(t, s, i));) s.splice(i, 1), i <= l && l--
                  }), this
              },
              has: function(e) {
              ...
              fireWith: function(e, t) {
                  return r || (t = [e, (t = t || []).slice ? t.slice() : t], a.push(t), o || i()), this
              },
              fire: function() {
              ...
              s = {
                  ...
                  then: function(t, i, n) {
                          ...
                          return function() {
                              function e() {
                                  ...
                                  if (!(o < l)) {
                                      ...
                                      t = e && ("object" == typeof e || "function" == typeof e) && e.then, b(t) ? a ? t.call(e, c(l, r, M, a), c(l, r, z, a)) : (l++, t.call(e, c(l, r, M, a), c(l, r, z, a), c(l, r, M, r.notifyWith))) : (s !== M && (i = void 0, n = [e]), (a || r.resolveWith)(i, n))
                                  }
                              }
                              var i = this,
                                  n = arguments,
                                  t = a ? e : function() {
                                      try {
                                          ...
                                          C.Deferred.exceptionHook && C.Deferred.exceptionHook(e, t.stackTrace), l <= o + 1 && (s !== z && (i = void 0, n = [e]), r.rejectWith(i, n))
                                      }
                                  };
                      ...
                      return C.Deferred(function(e) {
                          r[0][3].add(c(0, e, b(n) ? n : M, e.notifyWith)), r[1][3].add(c(0, e, b(t) ? t : M)), r[2][3].add(c(0, e, b(i) ? i : z))
                      }).promise()
                  },
                  promise: function(e) {
      ...
      when: function(e) {
          ...
          var i = arguments.length,
              ...
              r = a.call(arguments),
              s = C.Deferred();
          if (i <= 1 && (B(e, s.done(t(n)).resolve, s.reject, !i), "pending" === s.state() || b(r[n] && r[n].then))) return s.then();
  ...
  function q() {
      S.removeEventListener("DOMContentLoaded", q), E.removeEventListener("load", q), C.ready()
  }
  ...
  }), C.ready.then = R.then, "complete" === S.readyState || "loading" !== S.readyState && !S.documentElement.doScroll ? E.setTimeout(C.ready) : (S.addEventListener("DOMContentLoaded", q), E.addEventListener("load", q));
  ...
  C.extend({
      ...
      data: function(i, e) {
          ...
          if (void 0 !== i) return "object" == typeof i ? this.each(function() {
              ...
              var t;
              if (r && void 0 === e) return void 0 !== (t = G.get(r, i)) ? t : void 0 !== (t = Z(r, i)) ? t : void 0;
              this.each(function() {
                  G.set(this, i, e)
              })
          }, null, e, 1 < arguments.length, null, !0);
          if (this.length && (o = G.get(r), 1 === r.nodeType && !X.get(r, "hasDataAttrs"))) {
              for (t = s.length; t--;) s[t] && 0 === (n = s[t].name).indexOf("data-") && (n = U(n.slice(5)), Z(r, n, o[n]));
      ...
      queue: function(e, t, i) {
          var n;
          if (e) return t = (t || "fx") + "queue", n = X.get(e, t), i && (!n || Array.isArray(i) ? n = X.access(e, t, C.makeArray(i)) : n.push(i)), n || []
      },
      ...
      promise: function(e, t) {
          ...
          var n, o = 1,
              ...
              s = this,
              a = this.length;
          for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; a--;)(n = X.get(s[a], e + "queueHooks")) && n.empty && (o++, n.empty.add(i));
  ...
  function ue(e, t) {
      for (var i, n, o, r, s, a, l, c = [], u = 0, h = e.length; u < h; u++)(n = e[u]).style && (i = n.style.display, t ? ("none" === i && (c[u] = X.get(n, "display") || null, c[u] || (n.style.display = "")), "" === n.style.display && ae(n) && (c[u] = (l = s = r = void 0, s = (o = n).ownerDocument, a = o.nodeName, (l = ce[a]) || (r = s.body.appendChild(s.createElement(a)), l = C.css(r, "display"), r.parentNode.removeChild(r), "none" === l && (l = "block"), ce[a] = l)))) : "none" !== i && (c[u] = "none", X.set(n, "display", i)));
  ...
  function me(e, t) {
      var i;
      return i = void 0 !== e.getElementsByTagName ? e.getElementsByTagName(t || "*") : void 0 !== e.querySelectorAll ? e.querySelectorAll(t || "*") : [], void 0 === t || t && k(e, t) ? C.merge([e], i) : i
  }
  ...
  function _e(e, t, i, n, o) {
      for (var r, s, a, l, c, u, h = t.createDocumentFragment(), d = [], f = 0, p = e.length; f < p; f++)
          ...
          for (s = s || h.appendChild(t.createElement("div")), a = (de.exec(r) || ["", ""])[1].toLowerCase(), l = pe[a] || pe._default, s.innerHTML = l[1] + C.htmlPrefilter(r) + l[2], u = l[0]; u--;) s = s.lastChild;
          C.merge(d, s.childNodes), (s = h.firstChild).textContent = ""
      } else d.push(t.createTextNode(r));
      for (h.textContent = "", f = 0; r = d[f++];)
          if (n && -1 < C.inArray(r, n)) o && o.push(r);
          else if (c = oe(r), s = me(h.appendChild(r), "script"), c && ge(s), i)
          for (u = 0; r = s[u++];) fe.test(r.type || "") && i.push(r);
      return h
  }
  ve = S.createDocumentFragment().appendChild(S.createElement("div")), (ye = S.createElement("input")).setAttribute("type", "radio"), ye.setAttribute("checked", "checked"), ye.setAttribute("name", "t"), ve.appendChild(ye), y.checkClone = ve.cloneNode(!0).cloneNode(!0).lastChild.checked, ve.innerHTML = "<textarea>x</textarea>", y.noCloneChecked = !!ve.cloneNode(!0).lastChild.defaultValue;
  var we = /^key/,
  ...
  function Ae(e, o, r) {
      r ? (X.set(e, o, !1), C.event.add(e, o, {
          namespace: !1,
          handler: function(e) {
              var t, i, n = X.get(this, o);
              if (1 & e.isTrigger && this[o]) {
                  if (n.length)(C.event.special[o] || {}).delegateType && e.stopPropagation();
                  else if (n = a.call(arguments), X.set(this, o, n), t = r(this, o), this[o](), n !== (i = X.get(this, o)) || t ? X.set(this, o, !1) : i = {}, n !== i) return e.stopImmediatePropagation(), e.preventDefault(), i.value
  ...
  C.event = {
      ...
      add: function(t, e, i, n, o) {
          var r, s, a, l, c, u, h, d, f, p, m, g = X.get(t);
          if (g)
              for (i.handler && (i = (r = i).handler, o = r.selector), o && C.find.matchesSelector(ne, o), i.guid || (i.guid = C.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function(e) {
                      return void 0 !== C && C.event.triggered !== e.type ? C.event.dispatch.apply(t, arguments) : void 0
                  }), c = (e = (e || "").match(O) || [""]).length; c--;) f = m = (a = Ee.exec(e[c]) || [])[1], p = (a[2] || "").split(".").sort(), f && (h = C.event.special[f] || {}, f = (o ? h.delegateType : h.bindType) || f, h = C.event.special[f] || {}, u = C.extend({
                  type: f,
                  origType: m,
                  data: n,
                  handler: i,
      ...
      remove: function(e, t, i, n, o) {
          var r, s, a, l, c, u, h, d, f, p, m, g = X.hasData(e) && X.get(e);
          if (g && (l = g.events)) {
              for (c = (t = (t || "").match(O) || [""]).length; c--;)
                  if (f = m = (a = Ee.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), f) {
                      for (h = C.event.special[f] || {}, d = l[f = (n ? h.delegateType : h.bindType) || f] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = d.length; r--;) u = d[r], !o && m !== u.origType || i && i.guid !== u.guid || a && !a.test(u.namespace) || n && n !== u.selector && ("**" !== n || !u.selector) || (d.splice(r, 1), u.selector && d.delegateCount--, h.remove && h.remove.call(e, u));
                      s && !d.length && (h.teardown && !1 !== h.teardown.call(e, p, g.handle) || C.removeEvent(e, f, g.handle), delete l[f])
                  } else
      ...
      special: {
          ...
          click: {
              setup: function(e) {
                  var t = this || e;
                  return he.test(t.type) && t.click && k(t, "input") && Ae(t, "click", Se), !1
              },
              trigger: function(e) {
                  var t = this || e;
              ...
              _default: function(e) {
                  var t = e.target;
                  return he.test(t.type) && t.click && k(t, "input") && X.get(t, "click") || k(t, "a")
              }
          },
          beforeunload: {
      ...
      e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Se : Ce, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && C.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[C.expando] = !0
  }, C.Event.prototype = {
      constructor: C.Event,
  ...
  function ze(i, n, o, r) {
      ...
      var e, t, s, a, l, c, u = 0,
          ...
          f = n[0],
          p = b(f);
      if (p || 1 < h && "string" == typeof f && !y.checkClone && Le.test(f)) return i.each(function(e) {
          var t = i.eq(e);
          p && (n[0] = f.call(this, e, t.html())), ze(t, n, o, r)
      });
      if (h && (t = (e = _e(n, i[0].ownerDocument, !1, i, r)).firstChild, 1 === e.childNodes.length && (e = t), t || r)) {
          for (a = (s = C.map(me(e, "script"), Ne)).length; u < h; u++) l = e, u !== d && (l = C.clone(l, !0, !0), a && C.merge(s, me(l, "script"))), o.call(i[u], l, u);
          if (a)
              for (c = s[s.length - 1].ownerDocument, C.map(s, Oe), u = 0; u < a; u++) l = s[u], fe.test(l.type || "") && !X.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
  ...
  function Be(e, t, i) {
      for (var n, o = t ? C.filter(t, e) : e, r = 0; null != (n = o[r]); r++) i || 1 !== n.nodeType || C.cleanData(me(n)), n.parentNode && (i && oe(n) && ge(me(n, "script")), n.parentNode.removeChild(n));
      return e
  }
  C.extend({
      ...
      clone: function(e, t, i) {
          ...
          if (!(y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
              for (s = me(u), n = 0, o = (r = me(e)).length; n < o; n++) a = r[n], l = s[n], void 0, "input" === (c = l.nodeName.toLowerCase()) && he.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
          if (t)
              if (i)
                  for (r = r || me(e), s = s || me(u), n = 0, o = r.length; n < o; n++) Me(r[n], s[n]);
              else Me(e, u);
          return 0 < (s = me(u, "script")).length && ge(s, !h && me(e, "script")), u
      },
      ...
      html: function(e) {
          return F(this, function(e) {
              ...
              if ("string" == typeof e && !Ie.test(e) && !pe[(de.exec(e) || ["", ""])[1].toLowerCase()]) {
                  e = C.htmlPrefilter(e);
                  try {
                      for (; i < n; i++) 1 === (t = this[i] || {}).nodeType && (C.cleanData(me(t, !1)), t.innerHTML = e);
                      t = 0
                  } catch (e) {}
              }
      ...
      replaceWith: function() {
          ...
          return ze(this, arguments, function(e) {
              ...
              C.inArray(this, i) < 0 && (C.cleanData(me(this)), t && t.replaceChild(e, this))
          }, i)
      }
  }), C.each({
      appendTo: "append",
  ...
  var He, Re, qe, Fe, We, $e, Ve, Ue = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"),
      Ye = function(e) {
  ...
  function Xe() {
      if (Ve) {
          $e.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", Ve.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", ne.appendChild($e).appendChild(Ve);
          var e = E.getComputedStyle(Ve);
          He = "1%" !== e.top, We = 12 === Ge(e.marginLeft), Ve.style.right = "60%", Fe = 36 === Ge(e.right), Re = 36 === Ge(e.width), Ve.style.position = "absolute", qe = 12 === Ge(Ve.offsetWidth / 3), ne.removeChild($e), Ve = null
      }
  }
  ...
  function Ke(e, t, i) {
      ...
      return (i = i || Ye(e)) && ("" !== (s = i.getPropertyValue(t) || i[t]) || oe(e) || (s = C.style(e, t)), !y.pixelBoxStyles() && Ue.test(s) && Qe.test(t) && (n = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = i.width, a.width = n, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
  }
  ...
  $e = S.createElement("div"), (Ve = S.createElement("div")).style && (Ve.style.backgroundClip = "content-box", Ve.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === Ve.style.backgroundClip, C.extend(y, {
  ...
  function ct(e, t, i) {
      ...
      return (!y.boxSizingReliable() && o || "auto" === s || !parseFloat(s) && "inline" === C.css(e, "display", !1, n)) && e.getClientRects().length && (o = "border-box" === C.css(e, "boxSizing", !1, n), (r = a in e) && (s = e[a])), (s = parseFloat(s) || 0) + lt(e, t, i || (o ? "border" : "content"), r, n, s) + "px"
  }
  ...
  C.extend({
      ...
      style: function(e, t, i, n) {
          if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
              ...
              "string" === (r = typeof i) && (o = te.exec(i)) && o[1] && (i = le(e, t, o), r = "number"), null != i && i == i && ("number" !== r || l || (i += o && o[3] || (C.cssNumber[a] ? "" : "px")), y.clearCloneStyle || "" !== i || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (i = s.set(e, i, n)) || (l ? c.setProperty(t, i) : c[t] = i))
          }
      },
      css: function(e, t, i, n) {
          var o, r, s, a = U(t);
          return ot.test(t) || (t = it(a)), (s = C.cssHooks[t] || C.cssHooks[a]) && "get" in s && (o = s.get(e, !0, i)), void 0 === o && (o = Ke(e, t, n)), "normal" === o && t in st && (o = st[t]), "" === i || i ? (r = parseFloat(o), !0 === i || isFinite(r) ? r || 0 : o) : o
      }
  ...
  var ht, dt, ft, pt, mt = /^(?:toggle|show|hide)$/,
      gt = /queueHooks$/;

  function vt() {
      dt && (!1 === S.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(vt) : E.setTimeout(vt, C.fx.interval), C.fx.tick())
  }
  ...
  function _t(e, t, i) {
      for (var n, o = (wt.tweeners[t] || []).concat(wt.tweeners["*"]), r = 0, s = o.length; r < s; r++)
  ...
  function wt(r, e, t) {
      var i, s, n = 0,
          ...
          l = function() {
              if (s) return !1;
              for (var e = ht || yt(), t = Math.max(0, c.startTime + c.duration - e), i = 1 - (t / c.duration || 0), n = 0, o = c.tweens.length; n < o; n++) c.tweens[n].run(i);
      ...
      for (! function(e, t) {
              var i, n, o, r, s;
              for (i in e)
                  if (o = t[n = U(i)], r = e[i], Array.isArray(r) && (o = r[1], r = e[i] = r[0]), i !== n && (e[n] = r, delete e[i]), (s = C.cssHooks[n]) && "expand" in s)
                      for (i in r = s.expand(r), delete e[n], r) i in e || (e[i] = r[i], t[i] = o);
                  else t[n] = o
          }(u, c.opts.specialEasing); n < o; n++)
          if (i = wt.prefilters[n].call(c, r, u, c.opts)) return b(i.stop) && (C._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
      return C.map(u, _t, c), b(c.opts.start) && c.opts.start.call(r, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), C.fx.timer(C.extend(l, {
          elem: r,
          anim: c,
          queue: c.opts.queue
      })), c
  ...
  C.Animation = C.extend(wt, {
      ...
      tweener: function(e, t) {
          for (var i, n = 0, o = (e = b(e) ? (t = e, ["*"]) : e.match(O)).length; n < o; n++) i = e[n], wt.tweeners[i] = wt.tweeners[i] || [], wt.tweeners[i].unshift(t)
      },
      prefilters: [function(e, t, i) {
          var n, o, r, s, a, l, c, u, h = "width" in t || "height" in t,
              d = this,
              f = {},
              p = e.style,
              m = e.nodeType && ae(e),
          ...
          for (n in i.queue || (null == (s = C._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function() {
              ...
              for (n in h && 1 === e.nodeType && (i.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = g && g.display) && (c = X.get(e, "display")), "none" === (u = C.css(e, "display")) && (c ? u = c : (ue([e], !0), c = e.style.display || c, u = C.css(e, "display"), ue([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === C.css(e, "float") && (l || (d.done(function() {
                      p.display = c
                  ...
                  display: c
              }), r && (g.hidden = !m), m && ue([e], !0), d.done(function() {
                  for (n in m || ue([e]), X.remove(e, "fxshow"), f) C.style(e, n, f[n])
              })), l = _t(m ? g[n] : 0, n, d), n in g || (g[n] = l.start, m && (l.end = l.start, l.start = 0))
      }],
      ...
      stop: function(o, e, r) {
          ...
          return "string" != typeof o && (r = e, e = o, o = void 0), e && !1 !== o && this.queue(o || "fx", []), this.each(function() {
              ...
              if (t) n[t] && n[t].stop && s(n[t]);
                  ...
                  for (t in n) n[t] && n[t].stop && gt.test(t) && s(n[t]);
  ...
  }, ft = S.createElement("input"), pt = S.createElement("select").appendChild(S.createElement("option")), ft.type = "checkbox", y.checkOn = "" !== ft.value, y.optSelected = pt.selected, (ft = S.createElement("input")).value = "t", ft.type = "radio", y.radioValue = "t" === ft.value;
  var xt, Et = C.expr.attrHandle;
  C.fn.extend({
      attr: function(e, t) {
      ...
      attr: function(e, t, i) {
          ...
          if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? C.prop(e, t, i) : (1 === r && C.isXMLDoc(e) || (o = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? xt : void 0)), void 0 !== i ? null === i ? void C.removeAttr(e, t) : o && "set" in o && void 0 !== (n = o.set(e, i, t)) ? n : (e.setAttribute(t, i + ""), i) : o && "get" in o && null !== (n = o.get(e, t)) ? n : null == (n = C.find.attr(e, t)) ? void 0 : n)
      },
      attrHooks: {
          type: {
              set: function(e, t) {
      ...
      Et[t] = function(e, t, i) {
          ...
          return i || (o = Et[r], Et[r] = n, n = null != s(e, t, i) ? r : null, Et[r] = o), n
      }
  });
  ...
  C.fn.extend({
      ...
      toggleClass: function(o, t) {
          ...
          return "boolean" == typeof t && s ? t ? this.addClass(o) : this.removeClass(o) : b(o) ? this.each(function(e) {
              ...
              var e, t, i, n;
              if (s)
                  for (t = 0, i = C(this), n = At(o); e = n[t++];) i.hasClass(e) ? i.removeClass(e) : i.addClass(e);
              else void 0 !== o && "boolean" != r || ((e = kt(this)) && X.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === o ? "" : X.get(this, "__className__") || ""))
          })
      },
      hasClass: function(e) {
          var t, i, n = 0;
          for (t = " " + e + " "; i = this[n++];)
              if (1 === i.nodeType && -1 < (" " + Tt(kt(i)) + " ").indexOf(t)) return !0;
          return !1
      }
  });
  var Dt = /\r/g;
  ...
  C.extend(C.event, {
      trigger: function(e, t, i, n) {
          var o, r, s, a, l, c, u, h, d = [i || S],
              f = v.call(e, "type") ? e.type : e,
              p = v.call(e, "namespace") ? e.namespace.split(".") : [];
          if (r = h = s = i = i || S, 3 !== i.nodeType && 8 !== i.nodeType && !Lt.test(f + C.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), l = f.indexOf(":") < 0 && "on" + f, (e = e[C.expando] ? e : new C.Event(f, "object" == typeof e && e)).isTrigger = n ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), t = null == t ? [e] : C.makeArray(t, [e]), u = C.event.special[f] || {}, n || !u.trigger || !1 !== u.trigger.apply(i, t))) {
              if (!n && !u.noBubble && !m(i)) {
                  for (a = u.delegateType || f, Lt.test(a + f) || (r = r.parentNode); r; r = r.parentNode) d.push(r), s = r;
                  s === (i.ownerDocument || S) && d.push(s.defaultView || s.parentWindow || E)
              }
              for (o = 0;
                  (r = d[o++]) && !e.isPropagationStopped();) h = r, e.type = 1 < o ? a : u.bindType || f, (c = (X.get(r, "events") || {})[e.type] && X.get(r, "handle")) && c.apply(r, t), (c = l && r[l]) && c.apply && Y(r) && (e.result = c.apply(r, t), !1 === e.result && e.preventDefault());
              return e.type = f, n || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(d.pop(), t) || !Y(i) || l && b(i[f]) && !m(i) && ((s = i[l]) && (i[l] = null), C.event.triggered = f, e.isPropagationStopped() && h.addEventListener(f, It), i[f](), e.isPropagationStopped() && h.removeEventListener(f, It), C.event.triggered = void 0, s && (i[l] = s)), e.result
          }
      },
  ...
  function Ht(i, e, n, o) {
      ...
      if (Array.isArray(e)) C.each(e, function(e, t) {
          n || Ot.test(i) ? o(i, t) : Ht(i + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, n, o)
      });
      else if (n || "object" !== w(e)) o(i, e);
      else
          for (t in e) Ht(i + "[" + t + "]", e[t], n, o)
  }
  C.param = function(e, t) {
      ...
      serializeArray: function() {
          return this.map(function() {
              ...
              var e = this.type;
              return this.name && !C(this).is(":disabled") && Bt.test(this.nodeName) && !zt.test(e) && (this.checked || !he.test(e))
          }).map(function(e, t) {
              var i = C(this).val();
  ...
  Xt.href = Pt.href, C.extend({
      ...
      ajax: function(e, t) {
          ...
          var u, h, d, i, f, n, p, m, o, r, g = C.ajaxSetup({}, t),
              v = g.context || g,
              ...
              x = {
                  ...
                  getResponseHeader: function(e) {
                      ...
                      if (p) {
                          if (!i)
                              for (i = {}; t = Wt.exec(d);) i[t[1].toLowerCase() + " "] = (i[t[1].toLowerCase() + " "] || []).concat(t[2]);
                          t = i[e.toLowerCase() + " "]
                      }
          ...
          if (b.promise(x), g.url = ((e || g.url || Pt.href) + "").replace(Vt, Pt.protocol + "//"), g.type = t.method || t.type || g.method || g.type, g.dataTypes = (g.dataType || "*").toLowerCase().match(O) || [""], null == g.crossDomain) {
              n = S.createElement("a");
              try {
                  n.href = g.url, n.href = n.href, g.crossDomain = Xt.protocol + "//" + Xt.host != n.protocol + "//" + n.host
              } catch (e) {
                  g.crossDomain = !0
              }
          }
          if (g.data && g.processData && "string" != typeof g.data && (g.data = C.param(g.data, g.traditional)), Kt(Ut, g, t, x), p) return x;
          for (o in (m = C.event && g.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !$t.test(g.type), h = g.url.replace(qt, ""), g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Rt, "+")) : (r = g.url.slice(h.length), g.data && (g.processData || "string" == typeof g.data) && (h += (Nt.test(h) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (h = h.replace(Ft, "$1"), r = (Nt.test(h) ? "&" : "?") + "_=" + jt++ + r), g.url = h + r), g.ifModified && (C.lastModified[h] && x.setRequestHeader("If-Modified-Since", C.lastModified[h]), C.etag[h] && x.setRequestHeader("If-None-Match", C.etag[h])), (g.data && g.hasContent && !1 !== g.contentType || t.contentType) && x.setRequestHeader("Content-Type", g.contentType), x.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Qt + "; q=0.01" : "") : g.accepts["*"]), g.headers) x.setRequestHeader(o, g.headers[o]);
          if (g.beforeSend && (!1 === g.beforeSend.call(v, x, g) || p)) return x.abort();
          if (l = "abort", _.add(g.complete), x.done(g.success), x.fail(g.error), u = Kt(Yt, g, t, x)) {
          ...
          function c(e, t, i, n) {
              var o, r, s, a, l, c = t;
              p || (p = !0, f && E.clearTimeout(f), u = void 0, d = n || "", x.readyState = 0 < e ? 4 : 0, o = 200 <= e && e < 300 || 304 === e, i && (a = function(e, t, i) {
              ...
              }(g, a, x, o), o ? (g.ifModified && ((l = x.getResponseHeader("Last-Modified")) && (C.lastModified[h] = l), (l = x.getResponseHeader("etag")) && (C.etag[h] = l)), 204 === e || "HEAD" === g.type ? c = "nocontent" : 304 === e ? c = "notmodified" : (c = a.state, r = a.data, o = !(s = a.error))) : (s = c, !e && c || (c = "error", e < 0 && (e = 0))), x.status = e, x.statusText = (t || c) + "", o ? b.resolveWith(v, [r, c, x]) : b.rejectWith(v, [x, c, s]), x.statusCode(w), w = void 0, m && y.trigger(o ? "ajaxSuccess" : "ajaxError", [x, g, o ? r : s]), _.fireWith(v, [x, c]), m && (y.trigger("ajaxComplete", [x, g]), --C.active || C.event.trigger("ajaxStop")))
          }
          return x
      },
  ...
  y.cors = !!ei && "withCredentials" in ei, y.ajax = ei = !!ei, C.ajaxTransport(function(o) {
      var r, s;
      if (y.cors || ei && !o.crossDomain) return {
          send: function(e, t) {
              var i, n = o.xhr();
  ...
  C.ajaxSetup({
      ...
      if (s || "jsonp" === e.dataTypes[0]) return n = e.jsonpCallback = b(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(ni, "$1" + n) : !1 !== e.jsonp && (e.url += (Nt.test(e.url) ? "&" : "?") + e.jsonp + "=" + n), e.converters["script json"] = function() {
          return r || C.error(n + " was not called"), r[0]
      }, e.dataTypes[0] = "json", o = E[n], E[n] = function() {
          r = arguments
      }, i.always(function() {
          void 0 === o ? C(E).removeProp(n) : E[n] = o, e[n] && (e.jsonpCallback = t.jsonpCallback, ii.push(n)), r && b(o) && o(r[0]), r = o = void 0
      }), "script"
  }), y.createHTMLDocument = ((ti = S.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === ti.childNodes.length), C.parseHTML = function(e, t, i) {
      return "string" != typeof e ? [] : ("boolean" == typeof t && (i = t, t = !1), t || (y.createHTMLDocument ? ((n = (t = S.implementation.createHTMLDocument("")).createElement("base")).href = S.location.href, t.head.appendChild(n)) : t = S), r = !i && [], (o = A.exec(e)) ? [t.createElement(o[1])] : (o = _e([e], t, r), r && r.length && C(r).remove(), C.merge([], o.childNodes)));
      var n, o, r
  }, C.fn.load = function(e, t, i) {
      var n, o, r, s = this,
          a = e.indexOf(" ");
      return -1 < a && (n = Tt(e.slice(a)), e = e.slice(0, a)), b(t) ? (i = t, t = void 0) : t && "object" == typeof t && (o = "POST"), 0 < s.length && C.ajax({
          url: e,
          type: o || "GET",
          dataType: "html",
          data: t
      ...
      setOffset: function(e, t, i) {
          var n, o, r, s, a, l, c = C.css(e, "position"),
              u = C(e),
              h = {};
          "static" === c && (e.style.position = "relative"), a = u.offset(), r = C.css(e, "top"), l = C.css(e, "left"), o = ("absolute" === c || "fixed" === c) && -1 < (r + l).indexOf("auto") ? (s = (n = u.position()).top, n.left) : (s = parseFloat(r) || 0, parseFloat(l) || 0), b(t) && (t = t.call(e, i, C.extend({}, a))), null != t.top && (h.top = t.top - a.top + s), null != t.left && (h.left = t.left - a.left + o), "using" in t ? t.using.call(e, h) : u.css(h)
      }
  }, C.fn.extend({
      offset: function(t) {
      ...
      C.fn[t] = function(e) {
          return F(this, function(e, t, i) {
              var n;
              if (m(e) ? n = e : 9 === e.nodeType && (n = e.defaultView), void 0 === i) return n ? n[o] : e[t];
      ...
      C.cssHooks[i] = Je(y.pixelPosition, function(e, t) {
          if (t) return t = Ke(e, i), Ue.test(t) ? C(e).position()[i] + "px" : t
      })
  }), C.each({
      Height: "height",
      Width: "width"
  ...
  }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = k, C.isFunction = b, C.isWindow = m, C.camelCase = U, C.type = w, C.now = Date.now, C.isNumeric = function(e) {
      var t = C.type(e);
  ...
  return C.noConflict = function(e) {
      return E.$ === C && (E.$ = ri), e && E.jQuery === C && (E.jQuery = oi), C
  }, e || (E.jQuery = E.$ = C), C
}),
function(e, t) {
  ...
  p(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', u._handleDismiss(new u)), p.fn[r] = u._jQueryInterface, p.fn[r].Constructor = u, p.fn[r].noConflict = function() {
  ...
  var h = "button",
      ...
      b = function() {
          ...
          return e.toggle = function() {
                  ...
                  if (n) {
                      if ("radio" === n.type)
                          if (n.checked && this._element.classList.contains(g)) e = !1;
                              ...
                              o && p(o).removeClass(g)
                          } e && ("checkbox" !== n.type && "radio" !== n.type || (n.checked = !this._element.classList.contains(g)), p(n).trigger("change")), n.focus(), t = !1
                  }
              }
              ...
              return this.each(function() {
                  var e = p(this).data(d);
                  e || (e = new i(this), p(this).data(d, e)), "toggle" === t && e[t]()
              })
          }, s(i, null, [{
              key: "VERSION",
              get: function() {
  ...
  p(document).on("click.bs.button.data-api", v, function(e) {
      ...
      if (p(t).hasClass("btn") || (t = p(t).closest(".btn")[0]), !t || t.hasAttribute("disabled") || t.classList.contains("disabled")) e.preventDefault();
          ...
          "LABEL" === i.tagName && n && "checkbox" === n.type && e.preventDefault(), b._jQueryInterface.call(p(t), "toggle")
      }
      ...
      for (var e = [].slice.call(document.querySelectorAll('[data-toggle="buttons"] .btn')), t = 0, i = e.length; t < i; t++) {
          var n = e[t],
              o = n.querySelector(y);
          o.checked || o.hasAttribute("checked") ? n.classList.add(g) : n.classList.remove(g)
      }
  ...
  }), p.fn[h] = b._jQueryInterface, p.fn[h].Constructor = b, p.fn[h].noConflict = function() {
      ...
      P = function() {
          ...
          return e.next = function() {
              ...
              if (!(e > this._items.length - 1 || e < 0))
                  if (this._isSliding) p(this._element).one(A, function() {
                      return t.to(e)
                  });
                  else {
              ...
              p(this._element).off(x), p.removeData(this._element, w), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
              ...
              if (o = e === T ? (i = "carousel-item-left", n = "carousel-item-next", "left") : (i = "carousel-item-right", n = "carousel-item-prev", "right"), l && p(l).hasClass(D)) this._isSliding = !1;
                  ...
                  if (p(this._element).hasClass("slide")) {
                      p(l).addClass(n), m.reflow(l), p(s).addClass(i), p(l).addClass(i);
                      ...
                      p(s).one(m.TRANSITION_END, function() {
                          p(l).removeClass(i + " " + n).addClass(D), p(s).removeClass(D + " " + n + " " + i), r._isSliding = !1, setTimeout(function() {
                              return p(r._element).trigger(h)
                          }, 0)
                      }).emulateTransitionEnd(f)
                  } else p(s).removeClass(D), p(l).addClass(D), this._isSliding = !1, p(this._element).trigger(h);
                  u && this.cycle()
              }
              ...
              return this.each(function() {
                  ...
                  if (e || (e = new r(this, t), p(this).data(w, e)), "number" == typeof n) e.to(n);
              ...
              if (t) {
                  ...
                  if (i && p(i).hasClass("carousel")) {
                      ...
                      o && (n.interval = !1), r._jQueryInterface.call(p(i), n), o && p(i).data(w).to(o), e.preventDefault()
                  }
              }
          }, s(r, null, [{
              key: "VERSION",
  ...
  p(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", P._dataApiClickHandler), p(window).on("load.bs.carousel.data-api", function() {
      for (var e = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), t = 0, i = e.length; t < i; t++) {
          var n = p(e[t]);
          P._jQueryInterface.call(n, n.data())
      }
  }), p.fn[_] = P._jQueryInterface, p.fn[_].Constructor = P, p.fn[_].noConflict = function() {
  ...
  var j = "collapse",
      ...
      W = function() {
          function a(t, e) {
              ...
              for (var i = [].slice.call(document.querySelectorAll(F)), n = 0, o = i.length; n < o; n++) {
                  var r = i[n],
          ...
          return e.toggle = function() {
              ...
              if (!this._isTransitioning && !p(this._element).hasClass(B) && (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(e) {
                  ...
                  })).length && (e = null), !(e && (t = p(e).not(this._selector).data(N)) && t._isTransitioning))) {
                  var n = p.Event("show.bs.collapse");
                  if (p(this._element).trigger(n), !n.isDefaultPrevented()) {
                      e && (a._jQueryInterface.call(p(e).not(this._selector), "hide"), t || p(e).data(N, null));
                      var o = this._getDimension();
                      p(this._element).removeClass(H).addClass(R), this._element.style[o] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(q).attr("aria-expanded", !0), this.setTransitioning(!0);
                      var r = "scroll" + (o[0].toUpperCase() + o.slice(1)),
                          s = m.getTransitionDurationFromElement(this._element);
                      p(this._element).one(m.TRANSITION_END, function() {
                          p(i._element).removeClass(R).addClass(H + " " + B), i._element.style[o] = "", i.setTransitioning(!1), p(i._element).trigger("shown.bs.collapse")
              ...
              if (!this._isTransitioning && p(this._element).hasClass(B)) {
                  ...
                  if (p(this._element).trigger(t), !t.isDefaultPrevented()) {
                      ...
                      this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", m.reflow(this._element), p(this._element).addClass(R).removeClass(H + " " + B);
                      var n = this._triggerArray.length;
                      if (0 < n)
                          for (var o = 0; o < n; o++) {
                              var r = this._triggerArray[o],
                                  s = m.getSelectorFromElement(r);
                              if (null !== s) p([].slice.call(document.querySelectorAll(s))).hasClass(B) || p(r).addClass(q).attr("aria-expanded", !1)
                          }
                      this.setTransitioning(!0);
                      this._element.style[i] = "";
                      var a = m.getTransitionDurationFromElement(this._element);
                      p(this._element).one(m.TRANSITION_END, function() {
                          e.setTransitioning(!1), p(e._element).removeClass(R).addClass(H).trigger("hidden.bs.collapse")
              ...
              p.removeData(this._element, N), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
          }, e._getConfig = function(e) {
              return (e = l(l({}, M), e)).toggle = Boolean(e.toggle), m.typeCheckConfig(j, e, z), e
              ...
              return this.each(function() {
                  var e = p(this),
                      t = e.data(N),
                      i = l(l(l({}, M), e.data()), "object" == typeof n && n ? n : {});
                  if (!t && i.toggle && "string" == typeof n && /show|hide/.test(n) && (i.toggle = !1), t || (t = new a(this, i), e.data(N, t)), "string" == typeof n) {
  ...
  }), p.fn[j] = W._jQueryInterface, p.fn[j].Constructor = W, p.fn[j].noConflict = function() {
  ...
  var U = $ && window.Promise ? function(e) {
      var t = !1;
      return function() {
  ...
  function te(e) {
      ...
      var n = i && i.nodeName;
      return n && "BODY" !== n && "HTML" !== n ? -1 !== ["TH", "TD", "TABLE"].indexOf(i.nodeName) && "static" === Q(i, "position") ? te(i) : i : e ? e.ownerDocument.documentElement : document.documentElement
  }
  ...
  function ne(e, t) {
      ...
      if (e !== s && t !== s || n.contains(o)) return function(e) {
          var t = e.nodeName;
  ...
  function se(e, t, i, n) {
      return Math.max(t["offset" + e], t["scroll" + e], i["client" + e], i["offset" + e], i["scroll" + e], ee(10) ? parseInt(i["offset" + e]) + parseInt(n["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(n["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0)
  }
  ...
  function ae(e) {
      ...
      return {
          height: se("Height", t, i, n),
          width: se("Width", t, i, n)
      }
  }
  ...
  function pe(e, t, i) {
      ...
      return (o && !n ? t.contains(l) : t === l && "BODY" !== l.nodeName) && (d = function(e, t, i) {
          var n = 2 < arguments.length && void 0 !== i && i,
              o = oe(t, "top"),
              r = oe(t, "left"),
              s = n ? -1 : 1;
  ...
  function ge(e, t, i, n, o) {
      ...
      if ("viewport" === n) s = function(e, t) {
          ...
          var l = void 0;
          "scrollParent" === n ? "BODY" === (l = G(X(t))).nodeName && (l = e.ownerDocument.documentElement) : l = "window" === n ? e.ownerDocument.documentElement : n;
          var c = pe(l, a, r);
      ...
      return s.left += f ? i : i.left || 0, s.top += f ? i : i.top || 0, s.right -= f ? i : i.right || 0, s.bottom -= f ? i : i.bottom || 0, s
  }
  ...
  function we(e, t, i) {
      ...
      var n = be(e),
          ...
          l = r ? "height" : "width",
          c = r ? "width" : "height";
      return o[s] = t[s] + t[l] / 2 - n[l] / 2, o[a] = i === a ? t[a] - n[c] : t[_e(a)], o
  }
  ...
  function Ee(e, i, t) {
      return (void 0 === t ? e : e.slice(0, function(e, t, i) {
          ...
          e.enabled && Y(t) && (i.offsets.popper = de(i.offsets.popper), i.offsets.reference = de(i.offsets.reference), i = t(i, e))
      }), i
  }
  ...
  function ke(e, t, i, n) {
      i.updateBound = n, Te(e).addEventListener("resize", i.updateBound, {
          passive: !0
      });
      var o = G(e);
      return function e(t, i, n, o) {
          ...
          s.addEventListener(i, n, {
              passive: !0
          }), r || e(G(s.parentNode), i, n, o), o.push(s)
      }(o, "scroll", i.updateBound, i.scrollParents), i.scrollElement = o, i.eventsEnabled = !0, i
  }

  function Ae() {
      this.state.eventsEnabled && (cancelAnimationFrame(this.scheduleUpdate), this.state = function(e, t) {
          return Te(e).removeEventListener("resize", t.updateBound), t.scrollParents.forEach(function(e) {
  ...
  function Ie(i, n) {
      Object.keys(n).forEach(function(e) {
          var t = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && De(n[e]) && (t = "px"), i.style[e] = n[e] + t
      })
  }
          ...
          modifiers: {
              ...
              offset: {
                  ...
                  fn: function(e, t) {
                      var i = t.offset,
                          ...
                          a = n.split("-")[0],
                          l = void 0;
                      return l = De(+i) ? [+i, 0] : He(i, r, s, a), "left" === a ? (r.top += l[0], r.left -= l[1]) : "right" === a ? (r.top += l[0], r.left += l[1]) : "top" === a ? (r.left += l[0], r.top -= l[1]) : "bottom" === a && (r.left += l[0], r.top += l[1]), e.popper = r, e
                  },
                  offset: 0
              },
              preventOverflow: {
                  ...
                  fn: function(e, n) {
                      ...
                      var i = Ce("transform"),
                          ...
                          a = o[i];
                      o.top = "", o.left = "", o[i] = "";
                      var l = ge(e.instance.popper, e.instance.reference, n.padding, t, e.positionFixed);
                      ...
                      var c = n.priority,
                          ...
                          h = {
                              primary: function(e) {
                                  var t = u[e];
                                  return u[e] < l[e] && !n.escapeWithReference && (t = Math.max(u[e], l[e])), ue({}, e, t)
                              },
                              secondary: function(e) {
                                  var t = "right" === e ? "left" : "top",
                                      i = u[t];
                                  return u[e] > l[e] && !n.escapeWithReference && (i = Math.min(u[t], l[e] - ("right" === e ? u.width : u.height))), ue({}, t, i)
                              }
                          };
              ...
              arrow: {
                  ...
                  fn: function(e, t) {
                      ...
                      var o = e.placement.split("-")[0],
                          ...
                          f = l ? "bottom" : "right",
                          p = be(n)[c];
                      a[f] - p < s[h] && (e.offsets.popper[h] -= s[h] - (a[f] - p)), a[h] + p > s[f] && (e.offsets.popper[h] += a[h] + p - s[f]), e.offsets.popper = de(e.offsets.popper);
                      var m = a[h] + a[c] / 2 - p / 2,
                          g = Q(e.instance.popper),
                          v = parseFloat(g["margin" + u], 10),
                          y = parseFloat(g["border" + u + "Width"], 10),
                          b = m - e.offsets.popper[h] - v - y;
                      return b = Math.max(Math.min(s[c] - p, b), 0), e.arrowElement = n, e.offsets.arrow = (ue(i = {}, h, Math.round(b)), ue(i, d, ""), i), e
                  },
                  element: "[x-arrow]"
              },
              flip: {
                  ...
                  fn: function(m, g) {
                      ...
                      var v = ge(m.instance.popper, m.instance.reference, g.padding, g.boundariesElement, m.positionFixed),
                      ...
                      return w.forEach(function(e, t) {
                          ...
                          var i = m.offsets.popper,
                              ...
                              o = Math.floor,
                              r = "left" === y && o(i.right) > o(n.left) || "right" === y && o(i.left) < o(n.right) || "top" === y && o(i.bottom) > o(n.top) || "bottom" === y && o(i.top) < o(n.bottom),
                              s = o(i.left) < o(v.left),
                              ...
                              d = !!g.flipVariations && (h && "start" === _ && s || h && "end" === _ && a || !h && "start" === _ && l || !h && "end" === _ && c),
                              f = !!g.flipVariationsByContent && (h && "start" === _ && a || h && "end" === _ && s || !h && "start" === _ && c || !h && "end" === _ && l),
                              p = d || f;
                          (r || u || p) && (m.flipped = !0, (r || u) && (y = w[t + 1]), p && (_ = function(e) {
                              return "end" === e ? "start" : "start" === e ? "end" : e
                          }(_)), m.placement = y + (_ ? "-" + _ : ""), m.offsets.popper = he({}, m.offsets.popper, we(m.instance.popper, m.offsets.reference, m.placement)), m = Ee(m.instance.modifiers, m, "flip"))
                      }), m
                  },
                  behavior: "flip",
                  padding: 5,
              ...
              inner: {
                  ...
                  fn: function(e) {
                      ...
                      return o[s ? "left" : "top"] = r[i] - (a ? o[s ? "width" : "height"] : 0), e.placement = _e(t), e.offsets.popper = de(o), e
                  }
              },
              hide: {
                  order: 800,
              ...
              computeStyle: {
                  ...
                  fn: function(e, t) {
                      ...
                      var s = void 0 !== r ? r : t.gpuAcceleration,
                          ...
                          u = function(e, t) {
                              ...
                              var n = e.offsets,
                                  ...
                                  f = t ? s : i;
                              return {
                                  left: d(l % 2 == 1 && c % 2 == 1 && !h && t ? o.left - 1 : o.left),
                                  top: f(o.top),
                                  bottom: f(o.bottom),
                                  right: d(o.right)
                              }
                      ...
                      return e.attributes = he({}, y, e.attributes), e.styles = he({}, c, e.styles), e.arrowStyles = he({}, e.offsets.arrow, e.arrowStyles), e
                  },
                  gpuAcceleration: !0,
                  x: "bottom",
                  y: "right"
              ...
              applyStyle: {
                  ...
                  fn: function(e) {
                      return Ie(e.instance.popper, e.styles),
                          ...
                          }(e.instance.popper, e.attributes), e.arrowElement && Object.keys(e.arrowStyles).length && Ie(e.arrowElement, e.arrowStyles), e
                  },
                  onLoad: function(e, t, i, n, o) {
                      var r = ye(o, t, e, i.positionFixed),
                          s = ve(i.placement, r, t, e, i.modifiers.flip.boundariesElement, i.modifiers.flip.padding);
          ...
          value: function() {
              return function() {
                  if (!this.state.isDestroyed) {
                      ...
                      e.offsets.reference = ye(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = ve(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = we(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = Ee(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                  }
              }.call(this)
          }
      }, {
  ...
  function Fe(e, t) {
      ...
      ! function(e, t) {
      ...
      }(this, Fe), this.scheduleUpdate = function() {
          return requestAnimationFrame(i.update)
      }, this.update = U(this.update.bind(this)), this.options = he({}, Fe.Defaults, n), this.state = {
          isDestroyed: !1,
          isCreated: !1,
          scrollParents: []
      }, this.reference = e && e.jquery ? e[0] : e, this.popper = t && t.jquery ? t[0] : t, this.options.modifiers = {}, Object.keys(he({}, Fe.Defaults.modifiers, n.modifiers)).forEach(function(e) {
          i.options.modifiers[e] = he({}, Fe.Defaults.modifiers[e] || {}, n.modifiers ? n.modifiers[e] : {})
          ...
          e.enabled && Y(e.onLoad) && e.onLoad(i.reference, i.popper, i.options, e, i.state)
      }), this.update();
      var o = this.options.eventsEnabled;
      o && this.enableEventListeners(), this.state.eventsEnabled = o
  }
  qe.Utils = ("undefined" != typeof window ? window : global).PopperUtils, qe.placements = je, qe.Defaults = Re;
  var We = "dropdown",
      $e = "bs.dropdown",
      Ve = "." + $e,
      Ue = ".data-api",
      ...
      st = function() {
          ...
          return e.toggle = function() {
              ...
              if (void 0 === e && (e = !1), !(this._element.disabled || p(this._element).hasClass(Ze) || p(this._menu).hasClass(et))) {
                  var t = {
                  ...
                  if (p(n).trigger(i), !i.isDefaultPrevented()) {
                      if (!this._inNavbar && e) {
                          ...
                          var o = this._element;
                          "parent" === this._config.reference ? o = n : m.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(n).addClass("position-static"), this._popper = new qe(o, this._menu, this._getPopperConfig())
                      }
                      "ontouchstart" in document.documentElement && 0 === p(n).closest(".navbar-nav").length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(et), p(n).toggleClass(et).trigger(p.Event("shown.bs.dropdown", t))
                  }
              }
          }, e.hide = function() {
              if (!this._element.disabled && !p(this._element).hasClass(Ze) && p(this._menu).hasClass(et)) {
                  var e = {
                          relatedTarget: this._element
                      },
                      t = p.Event(Xe, e),
                      i = c._getParentFromElement(this._element);
                  p(i).trigger(t), t.isDefaultPrevented() || (this._popper && this._popper.destroy(), p(this._menu).toggleClass(et), p(i).toggleClass(et).trigger(p.Event(Ge, e)))
              }
          }, e.dispose = function() {
              p.removeData(this._element, $e), p(this._element).off(Ve), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
          }, e.update = function() {
              ...
              return e = l(l(l({}, this.constructor.Default), p(this._element).data()), e), m.typeCheckConfig(We, e, this.constructor.DefaultType), e
              ...
              var e = p(this._element.parentNode),
                  t = "bottom-start";
              return e.hasClass("dropup") ? t = p(this._menu).hasClass(tt) ? "top-end" : "top-start" : e.hasClass("dropright") ? t = "right-start" : e.hasClass("dropleft") ? t = "left-start" : p(this._menu).hasClass(tt) && (t = "bottom-end"), t
              ...
              return this.each(function() {
                  var e = p(this).data($e);
                  if (e || (e = new c(this, "object" == typeof t ? t : null), p(this).data($e, e)), "string" == typeof t) {
              ...
              if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                  for (var t = [].slice.call(document.querySelectorAll(it)), i = 0, n = t.length; i < n; i++) {
                      ...
                      if (e && "click" === e.type && (s.clickEvent = e), r) {
                          var a = r._menu;
                          if (p(o).hasClass(et) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(o, e.target))) {
                              var l = p.Event(Xe, s);
                              p(o).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), t[i].setAttribute("aria-expanded", "false"), r._popper && r._popper.destroy(), p(a).removeClass(et), p(o).removeClass(et).trigger(p.Event(Ge, s)))
                          }
                      }
                  }
              ...
              if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(nt).length)) : Qe.test(e.which)) && !this.disabled && !p(this).hasClass(Ze)) {
                  var t = c._getParentFromElement(this),
                      i = p(t).hasClass(et);
                  if (i || 27 !== e.which) {
                      if (e.preventDefault(), e.stopPropagation(), !i || i && (27 === e.which || 32 === e.which)) return 27 === e.which && p(t.querySelector(it)).trigger("focus"), void p(this).trigger("click");
                      ...
                      if (0 !== n.length) {
                          ...
                          38 === e.which && 0 < o && o--, 40 === e.which && o < n.length - 1 && o++, o < 0 && (o = 0), n[o].focus()
                      }
                  }
              }
          }, s(c, null, [{
  ...
  p(document).on(Je, it, st._dataApiKeydownHandler).on(Je, nt, st._dataApiKeydownHandler).on(Ke + " keyup.bs.dropdown.data-api", st._clearMenus).on(Ke, it, function(e) {
      e.preventDefault(), e.stopPropagation(), st._jQueryInterface.call(p(this), "toggle")
  }).on(Ke, ".dropdown form", function(e) {
      e.stopPropagation()
  }), p.fn[We] = st._jQueryInterface, p.fn[We].Constructor = st, p.fn[We].noConflict = function() {
      ...
      Tt = function() {
          ...
          return e.toggle = function(e) {
              ...
              if (!this._isShown && !this._isTransitioning) {
                  ...
                  p(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(vt, '[data-dismiss="modal"]', function(e) {
                      return t.hide(e)
              ...
              if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                  ...
                  if (p(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                      ...
                      if (n && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off(mt), p(this._element).removeClass(xt), p(this._element).off(vt), p(this._dialog).off(bt), n) {
              ...
              [window, this._element, this._dialog].forEach(function(e) {
                  return p(e).off(ct)
              }), p(document).off(mt), p.removeData(this._element, lt), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
              ...
              this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass("modal-dialog-scrollable") && n ? n.scrollTop = 0 : this._element.scrollTop = 0, i && m.reflow(this._element), p(this._element).addClass(xt), this._config.focus && this._enforceFocus();
              ...
              var t = this;
              p(document).off(mt).on(mt, function(e) {
                  document !== e.target && t._element !== e.target && 0 === p(t._element).has(e.target).length && t._element.focus()
              })
          }, e._setEscapeEvent = function() {
              var t = this;
              this._isShown ? p(this._element).on(yt, function(e) {
                  t._config.keyboard && 27 === e.which ? (e.preventDefault(), t.hide()) : t._config.keyboard || 27 !== e.which || t._triggerBackdropTransition()
              }) : this._isShown || p(this._element).off(yt)
          }, e._setResizeEvent = function() {
              var t = this;
              this._isShown ? p(window).on(gt, function(e) {
                  return t.handleUpdate(e)
              }) : p(window).off(gt)
          }, e._hideModal = function() {
              var e = this;
              this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function() {
                  p(document.body).removeClass(_t), e._resetAdjustments(), e._resetScrollbar(), p(e._element).trigger(ft)
              })
              ...
              if (this._isShown && this._config.backdrop) {
                  if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), p(this._backdrop).appendTo(document.body), p(this._element).on(vt, function(e) {
                          t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && t._triggerBackdropTransition()
                      }), i && m.reflow(this._backdrop), p(this._backdrop).addClass(xt), !e) return;
                  if (!i) return void e();
                  var n = m.getTransitionDurationFromElement(this._backdrop);
                  p(this._backdrop).one(m.TRANSITION_END, e).emulateTransitionEnd(n)
              ...
              return this.each(function() {
                  var e = p(this).data(lt),
                      t = l(l(l({}, ht), p(this).data()), "object" == typeof i && i ? i : {});
                  if (e || (e = new o(this, t), p(this).data(lt, e)), "string" == typeof i) {
                      if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                      e[i](n)
  ...
  p(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(e) {
      ...
      var o = p(t).data(lt) ? "toggle" : l(l({}, p(t).data()), p(this).data());
      "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
      var r = p(t).one(pt, function(e) {
          e.isDefaultPrevented() || r.one(ft, function() {
              p(i).is(":visible") && i.focus()
          })
      });
      Tt._jQueryInterface.call(p(t), o, this)
  }), p.fn[at] = Tt._jQueryInterface, p.fn[at].Constructor = Tt, p.fn[at].noConflict = function() {
      ...
      for (var i = (new window.DOMParser).parseFromString(e, "text/html"), a = Object.keys(s), l = [].slice.call(i.body.querySelectorAll("*")), n = function(e, t) {
              ...
              o.forEach(function(e) {
                  ! function(e, t) {
                      ...
                      if (-1 !== t.indexOf(i)) return -1 === kt.indexOf(i) || Boolean(e.nodeValue.match(Dt) || e.nodeValue.match(It));
          ...
          return e.enable = function() {
              ...
              if (this._isEnabled)
                  if (e) {
                      ...
                      if (p(this.getTipElement()).hasClass(Vt)) return void this._leave(null, this);
              ...
              if (this.isWithContent() && this._isEnabled) {
                  ...
                  o.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && p(o).addClass($t);
                  var s = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
                      a = this._getAttachment(s);
                  this.addAttachmentClass(a);
                  var l = this._getContainer();
                  p(o).data(this.constructor.DATA_KEY, this), p.contains(this.element.ownerDocument.documentElement, this.tip) || p(o).appendTo(l), p(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new qe(this.element, o, this._getPopperConfig(a)), p(o).addClass(Vt), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
                  var c = function() {
              ...
              function t() {
                  i._hoverState !== Ft && n.parentNode && n.parentNode.removeChild(n), i._cleanTipClass(), i.element.removeAttribute("aria-describedby"), p(i.element).trigger(i.constructor.Event.HIDDEN), null !== i._popper && i._popper.destroy(), e && e()
              }
              var i = this,
                  n = this.getTipElement(),
                  o = p.Event(this.constructor.Event.HIDE);
              if (p(this.element).trigger(o), !o.isDefaultPrevented()) {
                  if (p(n).removeClass(Vt), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger.click = !1, this._activeTrigger[Yt] = !1, this._activeTrigger[Ut] = !1, p(this.tip).hasClass($t)) {
              ...
              this.setElementContent(p(e.querySelectorAll(".tooltip-inner")), this.getTitle()), p(e).removeClass($t + " " + Vt)
          }, e.setElementContent = function(e, t) {
              "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = Lt(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t)) : e.text(t) : this.config.html ? p(t).parent().is(e) || e.empty().append(t) : e.text(p(t).text())
          }, e.getTitle = function() {
              ...
              this.config.trigger.split(" ").forEach(function(e) {
                  if ("click" === e) p(n.element).on(n.constructor.Event.CLICK, n.config.selector, function(e) {
                      return n.toggle(e)
                  });
                  else if ("manual" !== e) {
                      var t = e === Ut ? n.constructor.Event.MOUSEENTER : n.constructor.Event.FOCUSIN,
                          i = e === Ut ? n.constructor.Event.MOUSELEAVE : n.constructor.Event.FOCUSOUT;
                      p(n.element).on(t, n.config.selector, function(e) {
                          return n._enter(e)
              ...
              (t = t || p(e.currentTarget).data(i)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(i, t)), e && (t._activeTrigger["focusin" === e.type ? Yt : Ut] = !0), p(t.getTipElement()).hasClass(Vt) || t._hoverState === Ft ? t._hoverState = Ft : (clearTimeout(t._timeout), t._hoverState = Ft, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function() {
                  t._hoverState === Ft && t.show()
              }, t.config.delay.show) : t.show())
          }, e._leave = function(e, t) {
              var i = this.constructor.DATA_KEY;
              (t = t || p(e.currentTarget).data(i)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(i, t)), e && (t._activeTrigger["focusout" === e.type ? Yt : Ut] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = "out", t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function() {
              ...
              return Object.keys(t).forEach(function(e) {
                  ...
                  show: e.delay,
                  hide: e.delay
              }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), m.typeCheckConfig(Pt, e, this.constructor.DefaultType), e.sanitize && (e.template = Lt(e.template, e.whiteList, e.sanitizeFn)), e
              ...
              return this.each(function() {
                  var e = p(this).data(jt),
                      t = "object" == typeof i && i;
                  if ((e || !/dispose|hide/.test(i)) && (e || (e = new n(this, t), p(this).data(jt, e)), "string" == typeof i)) {
                      if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                      e[i]()
                  }
              })
  ...
  p.fn[Pt] = Qt._jQueryInterface, p.fn[Pt].Constructor = Qt, p.fn[Pt].noConflict = function() {
      ...
      oi = function(e) {
          ...
          return t.isWithContent = function() {
              ...
              return this.each(function() {
                  ...
                  if ((e || !/dispose|hide/.test(i)) && (e || (e = new n(this, t), p(this).data(Gt, e)), "string" == typeof i)) {
                      if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                      e[i]()
                  }
              })
  ...
  p.fn[Xt] = oi._jQueryInterface, p.fn[Xt].Constructor = oi, p.fn[Xt].noConflict = function() {
  ...
  var ri = "scrollspy",
      ...
      gi = function() {
          function i(e, t) {
              var i = this;
              this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(t), this._selector = this._config.target + " " + fi + "," + this._config.target + " " + pi + "," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on("scroll.bs.scrollspy", function(e) {
                  return i._process(e)
          ...
          return e.refresh = function() {
              ...
              p.removeData(this._element, si), p(this._scrollElement).off(ai), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
          }, e._getConfig = function(e) {
              if ("string" != typeof(e = l(l({}, ci), "object" == typeof e && e ? e : {})).target && m.isElement(e.target)) {
              ...
              i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(hi), i.addClass(hi)) : (i.addClass(hi), i.parents(di).prev(fi + ", " + pi).addClass(hi), i.parents(di).prev(".nav-item").children(fi).addClass(hi)), p(this._scrollElement).trigger("activate.bs.scrollspy", {
                  relatedTarget: t
              })
          }, e._clear = function() {
              ...
              return this.each(function() {
                  ...
                  if (e || (e = new i(this, "object" == typeof t && t), p(this).data(si, e)), "string" == typeof t) {
                      if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
                      e[t]()
                  }
              })
  ...
  }), p.fn[ri] = gi._jQueryInterface, p.fn[ri].Constructor = gi, p.fn[ri].noConflict = function() {
  ...
  var vi = "bs.tab",
      ...
      xi = function() {
          ...
          return e.show = function() {
              var i = this;
              if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(bi) || p(this._element).hasClass("disabled"))) {
                  var e, n, t = p(this._element).closest(".nav, .list-group")[0],
                  ...
                  if (n && p(n).trigger(s), p(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented()) {
              ...
              var o = this,
                  r = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children(_i) : p(t).find(wi))[0],
                  s = i && r && p(r).hasClass("fade");
              if (r && s) {
                  var a = m.getTransitionDurationFromElement(r);
                  p(r).removeClass("show").one(m.TRANSITION_END, n).emulateTransitionEnd(a)
              } else n()
          }, e._transitionComplete = function(e, t, i) {
              if (t) {
                  p(t).removeClass(bi);
                  var n = p(t.parentNode).find("> .dropdown-menu .active")[0];
                  n && p(n).removeClass(bi), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
              }
              if (p(e).addClass(bi), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), m.reflow(e), e.classList.contains("fade") && e.classList.add("show"), e.parentNode && p(e.parentNode).hasClass("dropdown-menu")) {
              ...
              return this.each(function() {
                  var e = p(this),
                      t = e.data(vi);
                  if (t || (t = new n(this), e.data(vi, t)), "string" == typeof i) {
      ...
      Pi = function() {
          ...
          return e.show = function() {
              ...
              if (p(this._element).trigger(t), !t.isDefaultPrevented()) {
                  ...
                  var i = function() {
                      e._element.classList.remove(Di), e._element.classList.add(Ai), p(e._element).trigger("shown.bs.toast"), e._config.autohide && (e._timeout = setTimeout(function() {
                          e.hide()
                      }, e._config.delay))
                  };
                  if (this._element.classList.remove("hide"), m.reflow(this._element), this._element.classList.add(Di), this._config.animation) {
                      var n = m.getTransitionDurationFromElement(this._element);
                      p(this._element).one(m.TRANSITION_END, i).emulateTransitionEnd(n)
                  } else i()
              }
          }, e.hide = function() {
              ...
              clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Ai) && this._element.classList.remove(Ai), p(this._element).off(ki), p.removeData(this._element, Si), this._element = null, this._config = null
          }, e._getConfig = function(e) {
              return e = l(l(l({}, Li), p(this._element).data()), "object" == typeof e && e ? e : {}), m.typeCheckConfig(Ei, e, this.constructor.DefaultType), e
          }, e._setListeners = function() {
              var e = this;
              ...
              return this.each(function() {
                  var e = p(this),
                      t = e.data(Si);
                  if (t || (t = new n(this, "object" == typeof i && i), e.data(Si, t)), "string" == typeof i) {
                      if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                      t[i](this)
                  }
              })
  ...
  p.fn[Ei] = Pi._jQueryInterface, p.fn[Ei].Constructor = Pi, p.fn[Ei].noConflict = function() {
      return p.fn[Ei] = Ti, Pi._jQueryInterface
  }, e.Alert = u, e.Button = b, e.Carousel = P, e.Collapse = W, e.Dropdown = st, e.Modal = Tt, e.Popover = oi, e.Scrollspy = gi, e.Tab = xi, e.Toast = Pi, e.Tooltip = Qt, e.Util = m, Object.defineProperty(e, "__esModule", {
      value: !0
  })
}),
function(t, i) {
  ...
  function o(c, o, u) {
      (u = u || t || e.jQuery) && (o.prototype.option || (o.prototype.option = function(e) {
          ...
          return "string" == typeof e ? function(e, r, s) {
              var a, l = "$()." + c + '("' + r + '")';
  ...
  function E(e) {
      if (function() {
              if (!x) {
                  ...
                  t.appendChild(e);
                  var i = _(e);
                  w = 200 == Math.round(v(i.width)), E.isBoxSizeOuter = w, t.removeChild(e)
              }
          ...
          var g = v(t.height);
          return !1 !== g && (i.height = g + (p ? 0 : c + f)), i.innerWidth = i.width - (l + d), i.innerHeight = i.height - (c + f), i.outerWidth = i.width + u, i.outerHeight = i.height + h, i
      }
  }
  return E
}),
...
function(s, a) {
  if ("function" == typeof define && define.amd) define("flickity/js/flickity", ["ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-utils/utils", "./cell", "./slide", "./animate"], function(e, t, i, n, o, r) {
      ...
      var e = s.Flickity;
      s.Flickity = a(s, s.EvEmitter, s.getSize, s.fizzyUIUtils, e.Cell, e.Slide, e.animatePrototype)
  }
  ...
  a.extend(p, e.prototype), p._create = function() {
      var e = this.guid = ++h;
      for (var t in this.element.flickityGUID = e, (d[e] = this).selectedIndex = 0, this.restingFrames = 0, this.x = 0, this.velocity = 0, this.originSide = this.options.rightToLeft ? "right" : "left", this.viewport = document.createElement("div"), this.viewport.className = "flickity-viewport", this._createSlider(), (this.options.resize || this.options.watchCSS) && n.addEventListener("resize", this), this.options.on) {
      ...
      if (this.slides = [], this.cells.length) {
          ...
          this.cells.forEach(function(e, t) {
              if (n.cells.length) {
                  ...
                  r.call(this, t, i) || (n.updateTarget(), n = new s(this), this.slides.push(n)), n.addCell(e)
              } else n.addCell(e)
  ...
  }, a.extend(p, o), f.data = function(e) {
      var t = (e = a.getQueryElement(e)) && e.flickityGUID;
      return t && d[t]
  }, a.htmlInit(f, "flickity"), l && l.bridget && l.bridget("flickity", f), f.setJQuery = function(e) {
      l = e
...
function(t, i) {
  ...
  function l(e, t, i) {
      ...
      }(n), this.options = s({}, this.options), "function" == typeof t ? i = t : s(this.options, t), i && this.on("always", i), this.getImages(), o && (this.jqDeferred = new o.Deferred), setTimeout(this.check.bind(this))) : r.error("Bad element for imagesLoaded " + (n || e))
...
function(e) {
  ...
  d.version = "master", d._groups = [], d._throttle = 80, d._maintainScroll = !1, d._beforeUpdate = null, d._afterUpdate = null, d._rows = u, d._parse = c, d._parseOptions = h, d._apply = function(e, t) {
      var r = h(t),
          i = l(e),
          n = [i],
      ...
      return a.each(function() {
      ...
      }), a.css("display", "block"), r.byRow && !r.target && (i.each(function() {
          var e = l(this),
              t = e.css("display");
          ...
          if (r.target) o = r.target.outerHeight(!1);
              ...
              i.each(function() {
                  ...
                  n[r.property] = "", e.css(n), e.outerHeight(!1) > o && (o = e.outerHeight(!1)), t ? e.attr("style", t) : e.css("display", "")
              })
          }
          i.each(function() {
              var e = l(this),
      ...
      }), d._maintainScroll && l(window).scrollTop(o / s * l("html").outerHeight(!0)), this
...
function(i) {
  ...
  var a, y, h = v.window.navigator,
      d = -1 < h.userAgent.indexOf("MSIE ") || -1 < h.userAgent.indexOf("Trident/") || -1 < h.userAgent.indexOf("Edge/"),
      l = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(h.userAgent),
      f = function() {
  ...
  p(), v.window.addEventListener("resize", p), v.window.addEventListener("orientationchange", p), v.window.addEventListener("load", p), o()(function() {
      p()
  });
  var m = [];

  function g() {
      m.length && (m.forEach(function(e, t) {
          var i = e.instance,
              n = e.oldData,
  ...
  function b(e, t) {
      ...
      for (var i, n = e.length, o = 0, r = arguments.length, s = new Array(2 < r ? r - 2 : 0), a = 2; a < r; a++) s[a - 2] = arguments[a];
      for (; o < n; o += 1)
          if ("object" === u(t) || void 0 === t ? e[o].jarallax || (e[o].jarallax = new w(e[o], t)) : e[o].jarallax && (i = e[o].jarallax[t].apply(e[o].jarallax, s)), void 0 !== i) return i;
      return e
  }
  var _ = 0,
      w = function() {
          function l(e, t) {
              ...
              var i = this;
              i.instanceID = _, _ += 1, i.$item = e, i.defaults = {
                  type: "scroll",
                  speed: .5,
                  imgSrc: null,
              ...
              if (Object.keys(n).forEach(function(e) {
                  ...
                  }), i.options = i.extend({}, i.defaults, o, t), i.pureOptions = i.extend({}, i.options), Object.keys(i.options).forEach(function(e) {
              ...
              a instanceof Element || (a = null), i.options.elementInViewport = a, i.image = {
                  ...
                  $container: null,
                  useImgTag: !1,
                  position: /iPad|iPhone|iPod|Android/.test(h.userAgent) ? "absolute" : "fixed"
          ...
          return function(e, t, i) {
              ...
              key: "css",
              value: function(t, i) {
                  return "string" == typeof i ? v.window.getComputedStyle(t).getPropertyValue(i) : (i.transform && f && (i[f] = i.transform), Object.keys(i).forEach(function(e) {
                      t.style[e] = i[e]
                  }), t)
              }
          }, {
              ...
              value: function(i) {
                  ...
                  return i = i || {}, Object.keys(n).forEach(function(t) {
              ...
              value: function() {
                  ...
                  if ("static" === e.css(e.$item, "position") && e.css(e.$item, {
                          ...
                          "max-width": "none"
                      }, t, i) : (e.image.$item = document.createElement("div"), e.image.src && (i = e.extend({
                  ...
                  i.position = e.image.position, e.css(e.image.$item, i), e.image.$container.appendChild(e.image.$item), e.onResize(), e.onScroll(!0), e.options.onInit && e.options.onInit.call(e), "none" !== e.css(e.$item, "background-image") && e.css(e.$item, {
              ...
              value: function() {
                  if ("fixed" === this.image.position) {
                      ...
                      var o = "#jarallax-container-".concat(e.instanceID, " {\n            clip: rect(0 ").concat(i, "px ").concat(n, "px 0);\n            clip: rect(0, ").concat(i, "px, ").concat(n, "px, 0);\n            -webkit-clip-path: polygon(0 0, 100% 0, 100% 100%, 0 100%);\n            clip-path: polygon(0 0, 100% 0, 100% 100%, 0 100%);\n        }");
              ...
              value: function() {
                  var e = this,
                      ...
                      s = i,
                      a = 0;
                  return o && (n < 0 ? (r = n * Math.max(i, y), y < i && (r -= n * (i - y))) : r = n * (i + y), 1 < n ? s = Math.abs(r - y) : n < 0 ? s = r / n + Math.abs(r) : s += (y - i) * (1 - n), r /= 2), e.parallaxScrollDistance = r, a = o ? (y - s) / 2 : (i - s) / 2, e.css(e.image.$item, {
                      height: "".concat(s, "px"),
              ...
              value: function(e) {
                  var t = this,
                      ...
                      r = {},
                      s = i;
                  if (t.options.elementInViewport && (s = t.options.elementInViewport.getBoundingClientRect()), t.isElementInViewport = 0 <= s.bottom && 0 <= s.right && s.top <= y && s.left <= v.window.innerWidth, e || t.isElementInViewport) {
                      var a = Math.max(0, n),
                          l = Math.max(0, o + n),
                          c = Math.max(0, -n),
                          u = Math.max(0, n + o - y),
                          ...
                          f = 1 - (y - n) / (y + o) * 2,
                          p = 1;
                      if (o < y ? p = 1 - (c || u) / o : l <= y ? p = l / y : h <= y && (p = h / y), "opacity" !== t.options.type && "scale-opacity" !== t.options.type && "scroll-opacity" !== t.options.type || (r.transform = "translate3d(0,0,0)", r.opacity = p), "scale" === t.options.type || "scale-opacity" === t.options.type) {
                          var m = 1;
                          t.options.speed < 0 ? m -= t.options.speed * p : m += t.options.speed * (1 - p), r.transform = "scale(".concat(m, ") translate3d(0,0,0)")
                      }
                      if ("scroll" === t.options.type || "scroll-opacity" === t.options.type) {
                          var g = t.parallaxScrollDistance * f;
                          "absolute" === t.image.position && (g -= n), r.transform = "translate3d(0,".concat(g, "px,0)")
                      }
...
function(i) {
  ...
  var n = i(2),
      ...
      s = i.n(r),
      a = i(5);
  Object(a.default)(), o()(function() {
      void 0 !== s.a.jarallax && s.a.jarallax(document.querySelectorAll("[data-jarallax-element]"))
  })
}, function(e, t) {
  e.exports = function(e) {
      "complete" === document.readyState || "interactive" === document.readyState ? e.call() : document.attachEvent ? document.attachEvent("onreadystatechange", function() {
  ...
  function r() {
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : o.a.jarallax;
      if (void 0 !== e) {
          var t = e.constructor;
          ["initImg", "canInitParallax", "init", "destroy", "clipContainer", "coverImage", "isVisible", "onScroll", "onResize"].forEach(function(m) {
              var g = t.prototype[m];
              t.prototype[m] = function() {
                  var e = this;
                  "initImg" === m && null !== e.$item.getAttribute("data-jarallax-element") && (e.options.type = "element", e.pureOptions.speed = e.$item.getAttribute("data-jarallax-element") || e.pureOptions.speed);
                  for (var t = arguments.length, i = new Array(t), n = 0; n < t; n++) i[n] = arguments[n];
                  if ("element" !== e.options.type) return g.apply(e, i);
                  switch (e.pureOptions.threshold = e.$item.getAttribute("data-threshold") || "", m) {
                      case "init":
                          ...
                          e.options.thresholdY = r[0] ? parseFloat(r[0]) : null, e.options.thresholdX = r[1] ? parseFloat(r[1]) : null, g.apply(e, i);
                      ...
                      case "onScroll":
                          var c = e.getWindowData(),
                              u = (c.y + c.height / 2 - e.itemData.y - e.itemData.height / 2) / (c.height / 2),
                              h = u * e.options.speedY,
                              d = u * e.options.speedX,
                              f = h,
                              p = d;
                          null !== e.options.thresholdY && h > e.options.thresholdY && (f = 0), null !== e.options.thresholdX && d > e.options.thresholdX && (p = 0), e.css(e.$item, {
                              transform: "translate3d(".concat(p, "px,").concat(f, "px,0)")
                          });
                          break;
                      case "initImg":
                      case "isVisible":
...
function(i) {
  ...
  var n = i(8),
      ...
      a = i.n(s),
      l = i(9);
  r.a.VideoWorker = r.a.VideoWorker || n.default, Object(l.default)(), a()(function() {
      void 0 !== r.a.jarallax && r.a.jarallax(document.querySelectorAll("[data-jarallax-video]"))
  })
}, function(e, t, i) {
  "use strict";
  i.r(t), i.d(t, "default", function() {
      ...
      m = function() {
          function n(e, t) {
              ...
              i.url = e, i.options_default = {
                  ...
                  startTime: 0,
                  endTime: 0
              }, i.options = i.extend({}, i.options_default, t), i.videoID = i.parseURL(e), i.videoID && (i.ID = a, a += 1, i.loadAPI(), i.init())
          }
          return function(e, t, i) {
              ...
              key: "parseURL",
              value: function(e) {
                  var t, i, n, o, r, s = !(!(t = e.match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) || 11 !== t[1].length) && t[1],
                      a = !(!(i = e.match(/https?:\/\/(?:www\.|player\.)?vimeo.com\/(?:channels\/(?:\w+\/)?|groups\/([^\/]*)\/videos\/|album\/(\d+)\/video\/|video\/|)(\d+)(?:$|\/|\?)/)) || !i[3]) && i[3],
                      l = (n = e.split(/,(?=mp4\:|webm\:|ogv\:|ogg\:)/), o = {}, r = 0, n.forEach(function(e) {
              ...
              value: function(i, n) {
                  var o = this;
                  this.userEventsList && this.userEventsList[i] && (n ? this.userEventsList[i].forEach(function(e, t) {
              ...
              key: "fire",
              value: function(e) {
                  for (var t = this, i = arguments.length, n = new Array(1 < i ? i - 1 : 0), o = 1; o < i; o++) n[o - 1] = arguments[o];
                  ...
                  if (i.videoImage) t(i.videoImage);
                      ...
                      if ("youtube" === i.type) {
                          var e = ["maxresdefault", "sddefault", "hqdefault", "0"],
                              ...
                              o = new Image;
                          o.onload = function() {
                              120 !== (this.naturalWidth || this.width) || n === e.length - 1 ? (i.videoImage = "https://img.youtube.com/vi/".concat(i.videoID, "/").concat(e[n], ".jpg"), t(i.videoImage)) : (n += 1, this.src = "https://img.youtube.com/vi/".concat(i.videoID, "/").concat(e[n], ".jpg"))
                          }, o.src = "https://img.youtube.com/vi/".concat(i.videoID, "/").concat(e[n], ".jpg")
                      }
                      if ("vimeo" === i.type) {
                          var r = new XMLHttpRequest;
                          r.open("GET", "https://vimeo.com/api/v2/video/".concat(i.videoID, ".json"), !0), r.onreadystatechange = function() {
                              if (4 === this.readyState && 200 <= this.status && this.status < 400) {
                                  var e = JSON.parse(this.responseText);
                                  i.videoImage = e[0].thumbnail_large, t(i.videoImage)
                              }
                          }, r.send(), r = null
                      }
                  }
                  ...
                  c.$video ? l(c.$video) : c.onAPIready(function() {
                      ...
                      if (c.$video || ((e = document.createElement("div")).style.display = "none"), "youtube" === c.type) {
                          ...
                          c.playerOptions = {}, c.playerOptions.videoId = c.videoID, c.playerOptions.playerVars = {
                              ...
                              autoplay: 0,
                              playsinline: 1
                          }, c.options.showContols || (c.playerOptions.playerVars.iv_load_policy = 3, c.playerOptions.playerVars.modestbranding = 1, c.playerOptions.playerVars.controls = 0, c.playerOptions.playerVars.showinfo = 0, c.playerOptions.playerVars.disablekb = 1), c.playerOptions.events = {
                              onReady: function(t) {
                                  if (c.options.mute ? t.target.mute() : c.options.volume && t.target.setVolume(c.options.volume), c.options.autoplay && c.play(c.options.startTime), c.fire("ready", t), c.options.loop && !c.options.endTime) {
                                      c.options.endTime = c.player.getDuration() - .1
                                  }
                              ...
                              onStateChange: function(e) {
                                  c.options.loop && e.data === u.a.YT.PlayerState.ENDED && c.play(c.options.startTime), i || e.data !== u.a.YT.PlayerState.PLAYING || (i = 1, c.fire("started", e)), e.data === u.a.YT.PlayerState.PLAYING && c.fire("play", e), e.data === u.a.YT.PlayerState.PAUSED && c.fire("pause", e), e.data === u.a.YT.PlayerState.ENDED && c.fire("ended", e), e.data === u.a.YT.PlayerState.PLAYING ? n = setInterval(function() {
                          ...
                          if (o) {
                              ...
                              r.setAttribute("id", c.playerID), e.appendChild(r), document.body.appendChild(e)
                          }
                          c.player = c.player || new u.a.YT.Player(c.playerID, c.playerOptions), o && (c.$video = document.getElementById(c.playerID), c.videoWidth = parseInt(c.$video.getAttribute("width"), 10) || 1280, c.videoHeight = parseInt(c.$video.getAttribute("height"), 10) || 720)
                      }
                      if ("vimeo" === c.type) {
                          if (c.playerOptions = {
                                  id: c.videoID,
                              ...
                              }, c.options.volume && (c.playerOptions.volume = c.options.volume), c.options.showContols || (c.playerOptions.badge = 0, c.playerOptions.byline = 0, c.playerOptions.portrait = 0, c.playerOptions.title = 0, c.playerOptions.background = 1), !c.$video) {
                              var s = "";
                              Object.keys(c.playerOptions).forEach(function(e) {
                                  "" !== s && (s += "&"), s += "".concat(e, "=").concat(encodeURIComponent(c.playerOptions[e]))
                              }), c.$video = document.createElement("iframe"), c.$video.setAttribute("id", c.playerID), c.$video.setAttribute("src", "https://player.vimeo.com/video/".concat(c.videoID, "?").concat(s)), c.$video.setAttribute("frameborder", "0"), c.$video.setAttribute("mozallowfullscreen", ""), c.$video.setAttribute("allowfullscreen", ""), e.appendChild(c.$video), document.body.appendChild(e)
                          }
                          var a;
                          c.player = c.player || new u.a.Vimeo.Player(c.$video, c.playerOptions), c.options.startTime && c.options.autoplay && c.player.setCurrentTime(c.options.startTime), c.player.getVideoWidth().then(function(e) {
                              c.videoWidth = e || 1280
                          }), c.player.getVideoHeight().then(function(e) {
                              c.videoHeight = e || 720
                          }), c.player.on("timeupdate", function(e) {
                              a || (c.fire("started", e), a = 1), c.fire("timeupdate", e), c.options.endTime && c.options.endTime && e.seconds >= c.options.endTime && (c.options.loop ? c.play(c.options.startTime) : c.pause())
              ...
              value: function() {
                  if (!l || !c) {
                      var e = "";
                      if ("youtube" !== this.type || l || (l = 1, e = "https://www.youtube.com/iframe_api"), "vimeo" === this.type && !c) {
              ...
              key: "onAPIready",
              value: function(e) {
                  if ("youtube" === this.type && (void 0 !== u.a.YT && 0 !== u.a.YT.loaded || h ? "object" === o(u.a.YT) && 1 === u.a.YT.loaded ? e() : f.done(function() {
                          e()
                      }) : (h = 1, window.onYouTubeIframeAPIReady = function() {
                          window.onYouTubeIframeAPIReady = null, f.resolve("done"), e()
                      })), "vimeo" === this.type)
                      if (void 0 !== u.a.Vimeo || d) void 0 !== u.a.Vimeo ? e() : p.done(function() {
                          e()
                      });
                      else {
                          d = 1;
                          var t = setInterval(function() {
                              void 0 !== u.a.Vimeo && (clearInterval(t), p.resolve("done"), e())
                          }, 20)
                      }
                  "local" === this.type && e()
              }
  ...
  function o() {
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : l.a.jarallax;
      if (void 0 !== e) {
          var t = e.constructor,
              n = t.prototype.onScroll;
          t.prototype.onScroll = function() {
              var i = this;
              n.apply(i), i.isVideoInserted || !i.video || i.options.videoLazyLoading && !i.isElementInViewport || i.options.disableVideo() || (i.isVideoInserted = !0, i.video.getVideo(function(e) {
                  var t = e.parentNode;
                  i.css(e, {
                      ...
                      margin: 0,
                      zIndex: -1
                  }), i.$video = e, "local" === i.video.type && (i.image.src ? i.$video.setAttribute("poster", i.image.src) : i.image.$item && "IMG" === i.image.$item.tagName && i.image.$item.src && i.$video.setAttribute("poster", i.image.$item.src)), i.image.$container.appendChild(e), t.parentNode.removeChild(t)
              }))
          };
          ...
          t.prototype.coverImage = function() {
              ...
              if (t && e.video && i && ("IFRAME" === i || "VIDEO" === i)) {
                  var n = t.image.height,
                      ...
                      s = t.image.marginTop;
                  t.container.width > o && (n = (o = t.container.width) * e.image.height / e.image.width, r = 0, s += (t.image.height - n) / 2), "IFRAME" === i && (n += 400, s -= 200), e.css(e.$video, {
                      width: "".concat(o, "px"),
          ...
          t.prototype.canInitParallax = function() {
              ...
              function n() {
                  i.image.$default_item && (i.image.$item = i.image.$default_item, i.image.$item.style.display = "block", i.coverImage(), i.clipContainer(), i.onScroll())
              }
              if (t.isValid())
                  if (this.options.disableParallax() && (e = !0, i.image.position = "absolute", i.options.type = "scroll", i.options.speed = 1), e) {
                      if (t.on("ready", function() {
                              if (i.options.videoPlayOnlyVisible) {
                                  var e = i.onScroll;
                                  i.onScroll = function() {
                                      e.apply(i), i.videoError || !i.options.videoLoop && (i.options.videoLoop || i.videoEnded) || (i.isVisible() ? t.play() : t.pause())
                                  }
                              } else t.play()
                              ...
                              i.videoError = !0, n()
                          }), i.video = t, !i.defaultInitImgResult && (i.image.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", "local" !== t.type)) return t.getImageURL(function(e) {
                          i.image.bgImage = 'url("'.concat(e, '")'), i.init()
                      }), !1
                  } else i.defaultInitImgResult || t.getImageURL(function(e) {
                      var t = i.$item.getAttribute("style");
                      t && i.$item.setAttribute("data-jarallax-original-styles", t), i.css(i.$item, {
...
function(e, t) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).Shuffle = t()
}(this, function() {
  "use strict";
  ...
  var c = "undefined" != typeof Element ? Element.prototype : {},
      u = c.matches || c.matchesSelector || c.webkitMatchesSelector || c.mozMatchesSelector || c.msMatchesSelector || c.oMatchesSelector,
      h = function(e, t) {
  ...
  var m = function() {
      ...
      g = function() {
          function r(e, t, i, n, o) {
              s(this, r), this.id = o, this.left = e, this.top = t, this.width = i, this.height = n
          }
          return e(r, null, [{
              key: "intersects",
              value: function(e, t) {
      ...
      b = function() {
          function t(e) {
              s(this, t), y += 1, this.id = y, this.element = e, this.isVisible = !0, this.isHidden = !1
          }
          return e(t, [{
              key: "show",
              value: function() {
              ...
              key: "init",
              value: function() {
                  this.addClasses([v.SHUFFLE_ITEM, v.VISIBLE]), this.applyCss(t.Css.INITIAL), this.scale = t.Scale.VISIBLE, this.point = new m
              }
          }, {
              key: "addClasses",
              value: function(e) {
  ...
  function _() {
      ...
      return t.style.cssText = "width:10px;padding:2px;box-sizing:border-box;", e.appendChild(t), w = "10px" === window.getComputedStyle(t, null).width, e.removeChild(t), w
  }
  var w = null;

  function x(e, t, i) {
      var n = 2 < arguments.length && void 0 !== i ? i : window.getComputedStyle(e, null),
          o = p(n[t]);
      return _() || "width" !== t ? _() || "height" !== t || (o += p(n.paddingTop) + p(n.paddingBottom) + p(n.borderTopWidth) + p(n.borderBottomWidth)) : o += p(n.paddingLeft) + p(n.paddingRight) + p(n.borderLeftWidth) + p(n.borderRightWidth), o
  }
  var E = {
      reverse: !1,
      by: null,
  ...
  function S(e, t) {
      ...
      return e.length ? o.randomize ? function(e) {
          ...
          var i = o.by(e[o.key]),
              n = o.by(t[o.key]);
          return void 0 === i && void 0 === n ? (r = !0, 0) : i < n || "sortFirst" === i || "sortLast" === n ? -1 : n < i || "sortLast" === i || "sortFirst" === n ? 1 : 0
      }) : "function" == typeof o.compare && e.sort(o.compare), r ? i : (o.reverse && e.reverse(), e)) : []
  }
  var C = {},
      T = "transitionend",
      k = 0;
  ...
  function A(e) {
      return !!C[e] && (C[e].element.removeEventListener(T, C[e].listener), !(C[e] = null))
  }
  ...
  function D(e, t) {
      ...
      var n = T + (k += 1);
      return e.addEventListener(T, i), C[n] = {
          element: e,
          listener: i
      }, n
  }
  ...
  function N(e, u) {
      ...
      }), [].concat.apply([], p).sort(function(e, t) {
          return e.id - t.id
      }).map(function(e) {
  ...
  var M = 0,
      z = function() {
          function r(e) {
              ...
              s(this, r), (t = a(this, o(r).call(this))).options = Object.assign({}, r.options, i), t.options.delimeter && (t.options.delimiter = t.options.delimeter), t.lastSort = {}, t.group = r.ALL_ITEMS, t.lastFilter = r.ALL_ITEMS, t.isEnabled = !0, t.isDestroyed = !1, t.isInitialized = !1, t._transitions = [], t.isTransitioning = !1, t._queue = [];
              var n = t._getElementOption(e);
              if (!n) throw new TypeError("Shuffle needs to be initialized with an element.");
              return t.element = n, t.id = "shuffle_" + M, M += 1, t._init(), t.isInitialized = !0, t
          }
          return function(e, t) {
              ...
              key: "_filter",
              value: function(e, t) {
                  var i = 0 < arguments.length && void 0 !== e ? e : this.lastFilter,
                      n = 1 < arguments.length && void 0 !== t ? t : this.items,
                      o = this._getFilteredSets(i, n);
                  return this._toggleFilterClasses(o), "string" == typeof(this.lastFilter = i) && (this.group = i), o
              }
          }, {
              ...
              value: function(t, e) {
                  ...
                  return t === r.ALL_ITEMS ? n = e : e.forEach(function(e) {
                      i._doesPassFilter(t, e.element) ? n.push(e) : o.push(e)
                  }), {
                      visible: n,
                      hidden: o
                  }
              ...
              value: function(e, t) {
                  ...
                  return Array.isArray(e) ? this.options.filterMode === r.FilterMode.ANY ? e.some(o) : e.every(o) : n.includes(e)
              }
          }, {
              ...
              value: function(e) {
                  var t = this.options,
                      ...
                      s = o.concat(r).join();
                  e.forEach(function(e) {
                      e.element.style.transitionDuration = i + "ms", e.element.style.transitionTimingFunction = n, e.element.style.transitionProperty = s
                  })
              }
          }, {
              key: "_getItems",
              ...
              value: function(e, t) {
                  var i;
                  return 0 === (i = "function" == typeof this.options.columnWidth ? this.options.columnWidth(e) : this.options.sizer ? r.getSize(this.options.sizer).width : this.options.columnWidth ? this.options.columnWidth : 0 < this.items.length ? r.getSize(this.items[0].element, !0).width : e) && (i = e), i + t
              }
          }, {
              key: "_getGutterSize",
              value: function(e) {
                  return "function" == typeof this.options.gutterWidth ? this.options.gutterWidth(e) : this.options.sizer ? x(this.options.sizer, "marginLeft") : this.options.gutterWidth
              }
          }, {
              key: "_setColumns",
              value: function(e) {
                  var t = 0 < arguments.length && void 0 !== e ? e : r.getSize(this.element).width,
                      i = this._getGutterSize(t),
                      n = this._getColumnSize(t, i),
                      o = (t + i) / n;
                  Math.abs(Math.round(o) - o) < this.options.columnThreshold && (o = Math.round(o)), this.cols = Math.max(Math.floor(o || 0), 1), this.containerWidth = t, this.colWidth = n
              }
          }, {
              ...
              value: function(e) {
                  ...
                  e.forEach(function(e, t) {
                      ...
                      if (m.equals(e.point, r[t]) && !e.isHidden) return e.applyCss(b.Css.VISIBLE.before), void i();
                      e.point = r[t], e.scale = b.Scale.VISIBLE, e.isHidden = !1;
                      var n = o.getStylesForTransition(e, b.Css.VISIBLE.before);
                      n.transitionDelay = o._getStaggerAmount(s) + "ms", o._queue.push({
                          item: e,
                          styles: n,
                          callback: i
                      }), s += 1
              ...
              value: function(e) {
                  return function(e) {
                      for (var t = e.itemSize, i = e.positions, n = e.gridSize, o = e.total, r = e.threshold, s = e.buffer, a = L(t.width, n, o, r), l = P(i, a, o), c = j(l, s), u = new m(n * c, l[c]), h = l[c] + t.height, d = 0; d < a; d++) i[c + d] = h;
                      return u
                  }({
                      itemSize: e,
              ...
              value: function(e) {
                  ...
                  t.forEach(function(e) {
                      ...
                      if (e.isHidden) return e.applyCss(b.Css.HIDDEN.before), void t();
                      e.scale = b.Scale.HIDDEN, e.isHidden = !0;
                      var i = n.getStylesForTransition(e, b.Css.HIDDEN.before);
                      i.transitionDelay = n._getStaggerAmount(o) + "ms", n._queue.push({
                          item: e,
                          styles: i,
                          callback: t
                      }), o += 1
              ...
              value: function(e, t) {
                  ...
                  if (this.options.useTransforms) {
                      var n = this.options.roundTransforms ? Math.round(e.point.x) : e.point.x,
                          o = this.options.roundTransforms ? Math.round(e.point.y) : e.point.y;
                      i.transform = "translate(".concat(n, "px, ").concat(o, "px) scale(").concat(e.scale, ")")
                  } else i.left = e.point.x + "px", i.top = e.point.y + "px";
                  return i
              }
          }, {
              ...
              value: function(t) {
                  var i = this;
                  return function(e) {
                      t.item.applyCss(t.styles), i._whenTransitionDone(t.item.element, t.callback, e)
                  }
              }
          }, {
              key: "_processQueue",
              ...
              value: function(e) {
                  ...
                  this.isTransitioning = !0,
                      function(e, i, n) {
                          n || ("function" == typeof i ? (n = i, i = null) : n = f);
                          var o = e && e.length;
                          if (!o) return n(null, []);
                          var r = !1,
                              s = new Array(o);
              ...
              value: function(e) {
                  ...
                  if (this.isEnabled) {
                      ...
                      this._layout(i), this._processQueue(), this._setContainerSize(), this.lastSort = t
                  }
              }
          }, {
              key: "update",
              ...
              value: function(e) {
                  ...
                  function o(e) {
                      e.scale = b.Scale.HIDDEN, e.isHidden = !0, e.applyCss(b.Css.HIDDEN.before), e.applyCss(b.Css.HIDDEN.after)
                  }
                  ...
                  s.visible.forEach(function(e, t) {
                      n(e) && (e.point = a[t], o(e), e.applyCss(i.getStylesForTransition(e, {})))
              ...
              value: function(e) {
                  ...
                  if (e.length) {
                      ...
                      this._toggleFilterClasses({
                          ...
                          t._disposeItems(n), i.forEach(function(e) {
              ...
              value: function(e, t) {
                  var i = 1 < arguments.length && void 0 !== t && t,
                      ...
                      o = x(e, "width", n),
                      r = x(e, "height", n);
                  i && (o += x(e, "marginLeft", n) + x(e, "marginRight", n), r += x(e, "marginTop", n) + x(e, "marginBottom", n));
                  return {
                      width: o,
                      height: r
                  }
  ...
  return z.ShuffleItem = b, z.ALL_ITEMS = "all", z.FILTER_ATTRIBUTE_KEY = "groups", z.EventType = {
      LAYOUT: "shuffle:layout",
      REMOVED: "shuffle:removed"
  }, z.Classes = v, z.FilterMode = {
      ANY: "any",
      ALL: "all"
  }, z.options = {
      group: z.ALL_ITEMS,
      ...
      isCentered: !1,
      roundTransforms: !0
  }, z.Point = m, z.Rect = g, z.__sorter = S, z.__getColumnSpan = L, z.__getAvailablePositions = P, z.__getShortColumn = j, z.__getCenteredPositions = N, z
}),
function(e, t) {
  ...
  var i = t(function(e, t) {
      (function(e) {
          ...
          var c, o, t = (o = {
              ...
              value: function() {
                  var e = this.dimensions;
                  e.sidebarLeft = u.offsetRelative(this.sidebar).left, e.viewportTop = document.documentElement.scrollTop || document.body.scrollTop, e.viewportBottom = e.viewportTop + e.viewportHeight, e.viewportLeft = document.documentElement.scrollLeft || document.body.scrollLeft, e.topSpacing = this.options.topSpacing, e.bottomSpacing = this.options.bottomSpacing, "function" == typeof e.topSpacing && (e.topSpacing = parseInt(e.topSpacing(this.sidebar)) || 0), "function" == typeof e.bottomSpacing && (e.bottomSpacing = parseInt(e.bottomSpacing(this.sidebar)) || 0), "VIEWPORT-TOP" === this.affixedType ? e.topSpacing < e.lastTopSpacing && (e.translateY += e.lastTopSpacing - e.topSpacing, this._reStyle = !0) : "VIEWPORT-BOTTOM" === this.affixedType && e.bottomSpacing < e.lastBottomSpacing && (e.translateY += e.lastBottomSpacing - e.bottomSpacing, this._reStyle = !0), e.lastTopSpacing = e.topSpacing, e.lastBottomSpacing = e.bottomSpacing
              }
          }, {
              ...
              value: function() {
                  var e = this.dimensions,
                      ...
                      n = e.viewportBottom - e.bottomSpacing,
                      o = this.affixedType;
                  return i <= e.translateY + e.containerTop ? (e.translateY = i - e.containerTop, o = "VIEWPORT-TOP") : e.containerBottom <= n ? (e.translateY = e.containerBottom - t, o = "CONTAINER-BOTTOM") : this.isSidebarFitsViewport() || e.containerTop <= i && 0 !== e.translateY && e.maxTranslateY !== e.translateY && (o = "VIEWPORT-UNBOTTOM"), o
              }
          }, {
              key: "_getStyle",
              value: function(e) {
                  if (void 0 !== e) {
                      ...
                      return t.outer = u.extend({
                          height: "",
                          position: ""
                      }, t.outer), t.inner = u.extend({
                          position: "relative",
                          top: "",
                          left: "",
                          bottom: "",
              ...
              value: function(e) {
                  if (!this._breakpoint) {
                      ...
                      if ((this.affixedType != t || e) && t) {
                          var n = "affix." + t.toLowerCase().replace("viewport-", "") + c;
                          for (var o in u.eventTrigger(this.sidebar, n), "STATIC" === t ? u.removeClass(this.sidebar, this.options.stickyClass) : u.addClass(this.sidebar, this.options.stickyClass), i.outer) {
                          ...
                          var l = "affixed." + t.toLowerCase().replace("viewport-", "") + c;
              ...
              value: function() {
                  window.innerWidth <= this.options.minWidth ? (this._breakpoint = !0, this.affixedType = "STATIC", this.sidebar.removeAttribute("style"), u.removeClass(this.sidebar, this.options.stickyClass), this.sidebarInner.removeAttribute("style")) : this._breakpoint = !1
              }
          }, {
              key: "updateSticky",
              value: function(e) {
                  ...
                  this._running || (this._running = !0, t = n.type, requestAnimationFrame(function() {
                      switch (t) {
                          case "scroll":
              ...
              value: function() {
                  var e = this.support;
                  e.transform = u.supportTransform(), e.transform3d = u.supportTransform(!0)
              }
          }, {
              key: "_getTranslate",
              value: function(e, t, i) {
                  ...
                  return this.support.transform3d ? "translate3d(" + n + ", " + o + ", " + r + ")" : !!this.support.translate && "translate(" + n + ", " + o + ")"
              }
          }, {
              key: "destroy",
              value: function() {
              ...
              value: function(e) {
                  ...
                  return (t + " " + ["Webkit", "Moz", "O", "ms"].join(n + " ") + n).split(" ").forEach(function(e, t) {
              ...
              key: "addClass",
              value: function(e, t) {
                  u.hasClass(e, t) || (e.classList ? e.classList.add(t) : e.className += " " + t)
              }
          }, {
              key: "removeClass",
              value: function(e, t) {
                  u.hasClass(e, t) && (e.classList ? e.classList.remove(t) : e.className = e.className.replace(new RegExp("(^|\\b)" + t.split(" ").join("|") + "(\\b|$)", "gi"), " "))
              }
          }, {
              key: "hasClass",
              value: function(e, t) {
          ...
          function u(e) {
              ...
              if (function(e, t) {
                      if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                  }(this, u), this.options = u.extend(o, i), this.sidebar = "string" == typeof e ? document.querySelector(e) : e, void 0 === this.sidebar) throw new Error("There is no specific sidebar element.");
                  ...
                  if (n) {
                      n.fn.stickySidebar = function(i) {
                          return this.each(function() {
                              var e = n(this),
                                  t = n(this).data(o);
                              if (t || (t = new r.default(this, "object" == typeof i && i), e.data(o, t)), "string" == typeof i) {
...
var objectFitImages = function() {
  ...
  var i = "bfred-it:object-fit-images",
      ...
      c = "object-position" in t.style,
      s = "background-size" in t.style,
      a = "string" == typeof t.currentSrc,
      u = t.getAttribute,
      l = t.setAttribute,
      g = !1;
  ...
  function m(t, e) {
      ...
      for (var n = 0; n < t.length; n++) t[n][i] = t[n][i] || {
          skipTest: e.skipTest
      }, b(t[n]);
      ...
      }, !0), g = !0, t = "img"), e.watchMQ && window.addEventListener("resize", m.bind(null, t, {
          skipTest: e.skipTest
      }))
  }
